...
def serialize_chat_message(chat_message) -> bytes | None:
    ...
    try:
        ...
        logger.exception("Value error during chat message serialization: %s", str(e))
        return None
...
def deserialize_chat_message(data: bytes) -> dict[str, Any] | None:
    ...
    try:
        ...
        logger.exception("Value error during message deserialization: %s", str(e))
        return None
...
def create_chat_response(message_id: str, content: str) -> bytes | None:
    ...
    try:
        ...
        logger.exception("Value error during chat response creation: %s", str(e))
        return None
...
def parse_chat_response(data: bytes) -> dict[str, Any] | None:
    ...
    try:
        ...
        logger.exception("Value error during chat response parsing: %s", str(e))
        return None
>>>>>>> 37e6b25 (Squashed commit of the following:)
