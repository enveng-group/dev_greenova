...
!((e, t) => {
	...
	function L(t, e) {
		...
		var a = ze[i + o],
			s =
				...
				(ze[i + o] =
					G(z(t, r), !0) ||
					(A(t) ? n : G((e) => (arguments.length ? (t[r] = e) : t[r]))));
		return (
			(s.target = t),
	...
	var E =
		((Observer.prototype.init = function init(e) {
			...
			(te = se._dc =
				...
				(se.disable = () => {
					se.isEnabled &&
						(Ie.filter((e) => e !== se && A(e.target)).length ||
							C(ve ? be : o, "scroll", F),
						se.isPressed &&
	...
	function Oa(e) {
		return (
			...
			(Ma(e)
				? () => ((Ot.width = Xe.innerWidth), (Ot.height = S), Ot)
				: () => _t(e))
		);
	}
	function Ra(e, t) {
	...
	function sc(c, e) {
		function Hk(e, t, r, n, i) {
			...
			return (
				...
				(t.inherit = !1),
				((t.modifiers = s)[f] = () =>
					l(r + n * o.ratio + i * o.ratio * o.ratio)),
				(t.onUpdate = () => {
					ze.cache++, Hk.tween && Z();
				}),
				(t.onComplete = () => {
		...
		return (
			((c[f] = u).wheelHandler = () =>
				Hk.tween && Hk.tween.kill() && (Hk.tween = 0)),
		...
		Mt = function _refreshAll(e, t) {
			if (
				...
				Zb(),
					...
					ze.forEach((e) => Ua(e) && ++e.cacheID && (e.rec = e()));
				var r = V("refreshInit");
				Ze && ne.sort(),
					t || Tb(),
					ze.forEach((e) => {
				...
				if (
							...
							(p = Ua(ue.snapTo)
								...
								: "labels" === ue.snapTo
									...
									: "labelsDirectional" === ue.snapTo
										...
										: !1 !== ue.directional
											? (e, t) =>
													ub(ue.snapTo)(e, at() - Pe < 500 ? 0 : t.direction)
					...
					if (
								...
								if (ae && e && st) xb(ScrollTrigger, "scrollEnd", Pb);
									...
									!rt && Te && Te(ke),
										...
										le &&
											...
											O.getChildren &&
												O.getChildren(!0, !0, !1).forEach(
													(e) => e.vars.immediateRender && e.render(0, !0, !0),
												)),
						...
						(ke.labelToScroll = (e) =>
							(O &&
								O.labels &&
								(B || ke.refresh() || B) + (O.labels[e] / O.duration()) * F) ||
							0),
						(ke.getTrailing = (t) => {
							var e = kt.indexOf(ke),
								r =
							...
							).filter((e) => (0 < ke.direction ? e.end <= B : e.start >= I));
						}),
						(ke.update = (e, t, r) => {
							if (!de || r || e) {
								var n,
								...
								if (
									...
									if (
										...
										ge &&
											...
											(Ua(ge)
												? ge(ke)
												: ke.getTrailing(ge).forEach((e) => e.endAnimation())),
										ve ||
											(!ee || Ke || ot
									...
									!ue || A.tween || Ke || ot || te.restart(!0),
										T &&
											(s || (ce && d && (d < 1 || !tt))) &&
											Je(T.targets).forEach((e) =>
												e.classList[n || ce ? "add" : "remove"](T.className),
											),
										!k || ve || e || k(ke),
										a && !Ke
											? (ve &&
