...
!((e, t) => {
	...
	function ScrollSmoother(t) {
		...
		function Na(t, r) {
			b.forEach((e) =>
				(function adjustEffectRelatedTriggers(e, t, r) {
		...
		function Qa() {
			return b && b.forEach((e) => e.vars.onRefresh(e));
		}
		function Ra() {
			return b && b.forEach((e) => e.vars.onRefreshInit(e)), Qa;
		}
		function Sa(r, n, o, i) {
			return () => {
		...
		Pa(),
			...
			(this.render = (e) => Ga(e || 0 === e ? e : N)),
			(this.getVelocity = () => z.getVelocity(-N)),
			Y.scrollerProxy(S, {
				scrollTop: Ha,
		...
		var O = Y.getAll().filter((e) => e.scroller === U || e.scroller === S);
		O.forEach((e) => e.revert(!0, !0)),
			(i = Y.create({
				animation: I.fromTo(
					B,
					{
			...
			(this.refresh = (e, t) => i.refresh(e, t)),
			P &&
			...
			"loading" === j.readyState || requestAnimationFrame(() => Y.refresh());
	}
	(r.version = "3.13.0"),
		(r.create = (e) =>
			Q && e && Q.content() === q(e.content)[0] ? Q : new r(e)),
		(r.get = () => Q),
