((e, t) => {
	...
	class a {
		constructor(e) {
			...
			this.addGrammarElement("feature", (e, t, r) => {
				if (r.matchOpToken("(")) {
			...
			this.addGrammarElement("command", (e, t, r) => {
				if (r.matchOpToken("(")) {
			...
			this.addGrammarElement("commandList", (e, t, r) => {
				if (r.hasMore()) {
			...
			this.addGrammarElement("leaf", (e, t, r) => {
			...
			this.addGrammarElement("indirectExpression", (e, t, r, n) => {
			...
			this.addGrammarElement("indirectStatement", (e, t, r, n) => {
			...
			this.addGrammarElement("primaryExpression", (e, t, r) => {
	...
	class o {
		...
		getEventQueueFor(e, t) {
			const r = this.getInternalData(e);
			var n = r.eventQueues;
			if (n == null) {
				n = new Map();
				r.eventQueues = n;
	...
	function s() {
		const e = document.cookie.split("; ").map((e) => {
			const t = e.split("=");
	...
	function T(t) {
		t.addLeafExpression("parenthesized", (e, t, r) => {
			if (r.matchOpToken("(")) {
		...
		t.addLeafExpression("string", (e, t, r) => {
		...
		t.addGrammarElement("nakedString", (e, t, r) => {
			if (r.hasMore()) {
				...
				return {
					type: "nakedString",
					tokens: n,
					evaluate: (e) => n.map((e) => e.value).join(""),
				};
			}
		});
		t.addLeafExpression("number", (e, t, r) => {
		...
		t.addLeafExpression("idRef", (e, t, r) => {
			...
			if (i.template) {
				...
				return {
					type: "idRefTemplate",
					args: [s],
					op: (e, r) => t.getRootNode(e.me).getElementById(r),
					evaluate: function (e) {
						return t.unifiedEval(this, e);
					},
				};
				...
				return {
					...
					css: i.value,
					value: e,
					evaluate: (r) => t.getRootNode(r.me).getElementById(e),
				};
			}
		});
		t.addLeafExpression("classRef", (e, t, r) => {
		...
		t.addLeafExpression("queryRef", (e, t, i) => {
		...
		t.addLeafExpression("attributeRef", (e, t, r) => {
		...
		t.addLeafExpression("styleRef", (e, t, r) => {
		...
		t.addGrammarElement("objectKey", (e, t, r) => {
			var n;
		...
		t.addLeafExpression("objectLiteral", (e, t, r) => {
		...
		t.addGrammarElement("nakedNamedArgumentList", (e, t, r) => {
			var n = [];
			var i = [];
		...
		t.addGrammarElement("namedArgumentList", (e, t, r) => {
			if (!r.matchOpToken("(")) return;
			var n = e.requireElement("nakedNamedArgumentList", r);
			r.requireOpToken(")");
			return n;
		});
		t.addGrammarElement("symbol", (e, t, r) => {
			var n = "default";
			...
			const i = r.matchOpToken(":");
			const a = r.matchTokenType("IDENTIFIER");
			if (a && a.value) {
				var o = a.value;
				if (i) {
					o = ":" + o;
				...
				return {
					...
					scope: n,
					name: o,
					evaluate: (e) => t.resolveSymbol(o, e, n),
				};
			}
		});
		t.addGrammarElement("implicitMeTarget", (e, t, r) => ({
			type: "implicitMeTarget",
			evaluate: (e) => e.you || e.me,
		}));
		t.addLeafExpression("boolean", (e, t, r) => {
		...
		t.addLeafExpression("null", (e, t, r) => {
		...
		t.addLeafExpression("arrayLiteral", (e, t, r) => {
			if (!r.matchOpToken("[")) return;
			var n = [];
			if (!r.matchOpToken("]")) {
				do {
		...
		t.addLeafExpression("blockLiteral", (e, t, r) => {
			if (!r.matchOpToken("\\")) return;
			var n = [];
		...
		t.addIndirectExpression("propertyAccess", (e, t, r, n) => {
			if (!r.matchOpToken(".")) return;
		...
		t.addIndirectExpression("of", (e, t, r, n) => {
		...
		t.addIndirectExpression("possessive", (e, t, r, n) => {
		...
		t.addIndirectExpression("inExpression", (e, t, r, n) => {
		...
		t.addIndirectExpression("asExpression", (e, t, r, n) => {
		...
		t.addIndirectExpression("functionCall", (e, t, r, n) => {
			if (!r.matchOpToken("(")) return;
			var i = [];
			if (!r.matchOpToken(")")) {
				do {
		...
		t.addIndirectExpression("attributeRefAccess", (e, t, r, n) => {
		...
		t.addIndirectExpression("arrayIndex", (e, t, r, n) => {
			if (!r.matchOpToken("[")) return;
			var i = false;
			var a = false;
			var o = null;
		...
		t.addGrammarElement("postfixExpression", (e, t, r) => {
			var n = e.parseElement("negativeNumber", r);
			const i = r.matchAnyToken.apply(r, a) || r.matchOpToken("%");
			if (i) {
				return {
					type: "stringPostfix",
					postfix: i.value,
		...
		t.addGrammarElement("logicalNot", (e, t, r) => {
		...
		t.addGrammarElement("noExpression", (e, t, r) => {
		...
		t.addLeafExpression("some", (e, t, r) => {
		...
		t.addGrammarElement("negativeNumber", (e, t, r) => {
			if (r.matchOpToken("-")) {
		...
		t.addGrammarElement("unaryExpression", (e, t, r) => {
			r.matchToken("the");
			return e.parseAnyOf(
				[
					"beepExpression",
		...
		t.addGrammarElement("beepExpression", (e, t, r) => {
		...
		var c = (e, t, r, n) => l(e, Array.from(t).reverse(), r, n);
		t.addGrammarElement("relativePositionalExpression", (e, t, r) => {
		...
		t.addGrammarElement("positionalExpression", (e, t, r) => {
		...
		t.addGrammarElement("mathOperator", (e, t, r) => {
			var n = e.parseElement("unaryExpression", r);
			var i,
				a = null;
		...
		t.addGrammarElement("mathExpression", (e, t, r) =>
			e.parseAnyOf(["mathOperator", "unaryExpression"], r),
		);
		function f(e, t, r) {
			if (t["contains"]) {
				return t.contains(r);
		...
		t.addGrammarElement("comparisonOperator", (e, t, r) => {
		...
		t.addGrammarElement("comparisonExpression", (e, t, r) =>
			e.parseAnyOf(["comparisonOperator", "mathExpression"], r),
		);
		t.addGrammarElement("logicalOperator", (e, t, r) => {
		...
		t.addGrammarElement("logicalExpression", (e, t, r) =>
			e.parseAnyOf(["logicalOperator", "mathExpression"], r),
		);
		t.addGrammarElement("asyncExpression", (e, t, r) => {
		...
		t.addGrammarElement("expression", (e, t, r) => {
			r.matchToken("the");
			return e.parseElement("asyncExpression", r);
		});
		t.addGrammarElement("assignableExpression", (e, t, r) => {
			r.matchToken("the");
		...
		t.addGrammarElement("hyperscript", (e, t, r) => {
			var n = [];
			if (r.hasMore()) {
				while (
		...
		t.addFeature("on", (e, t, r) => {
			...
			var O = {
				...
				errorSymbol: R,
				execute: (e) => {
					const r = t.getEventQueueFor(e.me, O);
					...
					for (const r of O.events) {
						...
						t.implicitLoop(n, (n) => {
							...
							if (r.mutationSpec) {
								...
								const e = new MutationObserver((e, r) => {
									if (!O.executing) {
		...
		t.addFeature("def", (e, t, r) => {
			...
			var m = {
				displayName: o + "(" + s.map((e) => e.value).join(", ") + ")",
				name: o,
				args: s,
				start: u,
				errorHandler: c,
		...
		t.addFeature("set", (e, t, r) => {
			const n = e.parseElement("setCommand", r);
			if (n) {
		...
		t.addGrammarElement("jsBody", (e, t, r) => {
		...
		t.addFeature("js", (t, r, n) => {
			if (!n.matchToken("js")) return;
			var i = t.requireElement("jsBody", n);
			var a =
				i.jsSource +
				"\nreturn { " +
				i.exposedFunctionNames.map((e) => e + ":" + e).join(",") +
				" } ";
		...
		t.addGrammarElement("dotOrColonPath", (e, t, r) => {
			...
			if (n) {
				...
				return {
					type: "dotOrColonPath",
					path: i,
					evaluate: () => i.join(a ? a.value : ""),
				};
			}
		});
		t.addGrammarElement("eventName", (e, t, r) => {
			var n;
			if ((n = r.matchTokenType("STRING"))) {
				return {
					evaluate: () => n.value,
		...
		t.addCommand("trigger", (e, t, r) => {
			if (r.matchToken("trigger")) {
				return d("trigger", e, t, r);
			}
		});
		t.addCommand("send", (e, t, r) => {
		...
		t.addCommand("return", (e, t, r) => {
			if (r.matchToken("return")) {
				return T(e, t, r, true);
			}
		});
		t.addCommand("exit", (e, t, r) => {
			if (r.matchToken("exit")) {
				return T(e, t, r, false);
			}
		});
		t.addCommand("halt", (e, t, r) => {
		...
		t.addCommand("get", (e, t, r) => {
			if (r.matchToken("get")) {
				return y(e, t, r);
			}
		});
		t.addCommand("make", (e, t, r) => {
		...
		t.addGrammarElement("pseudoCommand", (e, t, r) => {
			const n = r.token(1);
		...
		t.addCommand("if", (e, t, r) => {
			if (!r.matchToken("if")) return;
			var n = e.requireElement("expression", r);
			r.matchToken("then");
			var i = e.parseElement("commandList", r);
			var a = false;
			const o = r.matchToken("else") || r.matchToken("otherwise");
			if (o) {
				const t = r.peekToken("if");
		...
		t.addCommand("repeat", (e, t, r) => {
			if (r.matchToken("repeat")) {
				return x(e, r, t, false);
			}
		});
		t.addCommand("for", (e, t, r) => {
			if (r.matchToken("for")) {
				return x(e, r, t, true);
			}
		});
		t.addCommand("continue", (e, t, r) => {
		...
		t.addGrammarElement("stringLike", (e, t, r) =>
			e.parseAnyOf(["string", "nakedString"], r),
		);
		t.addCommand("append", (e, t, r) => {
			if (!r.matchToken("append")) return;
			var n = null;
			var i = e.requireElement("expression", r);
			var a = {
				type: "symbol",
				evaluate: (e) => t.resolveSymbol("result", e),
			};
			if (r.matchToken("to")) {
	...
	function y(e) {
						...
						op: function (e, r, n) {
							...
							t.forEach(n, (n) => {
								t.implicitLoop(r, (r) => {
									if (u) {
										e.result = r;
										const i = t.evaluateNoPromise(u, e);
										if (i) {
					...
					return {
						...
						op: function (e, r, n) {
							...
							t.implicitLoop(r, (r) => {
								if (u) {
									e.result = r;
									const n = t.evaluateNoPromise(u, e);
									if (n) {
		...
		e.addGrammarElement("styleLiteral", (e, t, r) => {
			if (!r.matchOpToken("{")) return;
			var n = [""];
			var i = [];
			while (r.hasMore()) {
				...
				return {
					...
					op: function (e, r) {
						...
						t.implicitLoop(r, (r) => {
							if (l) {
								e.result = r;
								const n = t.evaluateNoPromise(l, e);
								if (n) {
									c("show", r, s);
								} else {
									c("hide", r);
		...
		function o(e, t, r) {
			...
			if (
				...
				n = {
					...
					token: i,
					name: i.value,
					evaluate: (e) => t.resolveSymbol("it", e),
				};
			} else {
			...
			if (n.matchToken("transition")) {
				...
				while (
					...
					if (n.currentToken().type === "STYLE_REF") {
						const e = n.consumeToken();
						const t = e.value.substr(1);
						a.push({
							type: "styleRefValue",
							evaluate: () => t,
						});
				...
				var m = {
					...
					op: (e, n, a, o, s, u, l) => {
						...
						return Promise.all(c).then(() => t.findNext(m, e));
					},
				};
				return m;
			}
		});
		e.addCommand("measure", (e, t, r) => {
		...
		e.addLeafExpression("closestExpr", (e, t, r) => {
						...
						if (n) {
							...
							t.implicitLoop(r, (e) => {
								...
								if (l) {
									...
									const n = l.value === "+" ? i : i * -1;
									const a = m.inline == "start" || m.inline == "end" ? n : 0;
									const o = m.block == "start" || m.block == "end" ? n : 0;
		...
		r.conversions.dynamicResolvers.push((t, r) => {
		...
		r.conversions["Fragment"] = (t) => {
			var r = document.createDocumentFragment();
			e.runtime.implicitLoop(t, (e) => {
	...
	function w() {
		...
		Promise.all(t.map((e) => fetch(e.src).then((e) => e.text())))
			...
			.then(() =>
				n(() => {
					...
					e.document.addEventListener("htmx:load", (e) => {
