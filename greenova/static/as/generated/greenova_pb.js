...
$root.company = (() => {
  ...
  company.CompanyProto = (() => {
    ...
    function CompanyProto (properties) {
      this.memberUserIds = []
      if (properties) {
        for (let keys = Object.keys(properties), i = 0; i < keys.length; i += 1) { if (properties[keys[i]] != null) {
    ...
    CompanyProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (message.name != null && Object.hasOwn(message, 'name')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.name) }
      if (message.logoUrl != null && Object.hasOwn(message, 'logoUrl')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.logoUrl) }
      if (message.description != null && Object.hasOwn(message, 'description')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.description) }
      if (message.website != null && Object.hasOwn(message, 'website')) { writer.uint32(/* id 5, wireType 2 = */ 42).string(message.website) }
      if (message.address != null && Object.hasOwn(message, 'address')) { writer.uint32(/* id 6, wireType 2 = */ 50).string(message.address) }
      if (message.phone != null && Object.hasOwn(message, 'phone')) { writer.uint32(/* id 7, wireType 2 = */ 58).string(message.phone) }
      if (message.email != null && Object.hasOwn(message, 'email')) { writer.uint32(/* id 8, wireType 2 = */ 66).string(message.email) }
      if (message.companyType != null && Object.hasOwn(message, 'companyType')) { writer.uint32(/* id 9, wireType 2 = */ 74).string(message.companyType) }
      if (message.size != null && Object.hasOwn(message, 'size')) { writer.uint32(/* id 10, wireType 2 = */ 82).string(message.size) }
      if (message.industry != null && Object.hasOwn(message, 'industry')) { writer.uint32(/* id 11, wireType 2 = */ 90).string(message.industry) }
      if (message.isActive != null && Object.hasOwn(message, 'isActive')) { writer.uint32(/* id 12, wireType 0 = */ 96).bool(message.isActive) }
      if (message.memberUserIds != null && message.memberUserIds.length) {
        for (let i = 0; i < message.memberUserIds.length; i += 1) {
          writer
            .uint32(/* id 13, wireType 2 = */ 106)
            .string(message.memberUserIds[i])
        }
      }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 14, wireType 2 = */ 114).string(message.createdAt) }
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) { writer.uint32(/* id 15, wireType 2 = */ 122).string(message.updatedAt) }
      return writer
    }
    ...
    CompanyProto.decode = function decode (reader, length, error) {
      ...
      const message = new $root.company.CompanyProto()
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 13: {
            if (!(message.memberUserIds && message.memberUserIds.length)) { message.memberUserIds = [] }
    ...
    CompanyProto.verify = function verify (message) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { if (!$util.isString(message.id)) {
        return 'id: string expected' ;
      }}
      if (message.name != null && Object.hasOwn(message, 'name')) { if (!$util.isString(message.name)) {
        return 'name: string expected' ;
      }}
      if (message.logoUrl != null && Object.hasOwn(message, 'logoUrl')) { if (!$util.isString(message.logoUrl)) {
      ...
      if (message.website != null && Object.hasOwn(message, 'website')) { if (!$util.isString(message.website)) {
        return 'website: string expected' ;
      }}
      if (message.address != null && Object.hasOwn(message, 'address')) { if (!$util.isString(message.address)) {
        return 'address: string expected' ;
      }}
      if (message.phone != null && Object.hasOwn(message, 'phone')) { if (!$util.isString(message.phone)) {
        return 'phone: string expected' ;
      }}
      if (message.email != null && Object.hasOwn(message, 'email')) { if (!$util.isString(message.email)) {
        return 'email: string expected' ;
      }}
      if (message.companyType != null && Object.hasOwn(message, 'companyType')) {
        if (!$util.isString(message.companyType)) { return 'companyType: string expected' }
      }
      if (message.size != null && Object.hasOwn(message, 'size')) { if (!$util.isString(message.size)) {
        return 'size: string expected' ;
      }}
      if (message.industry != null && Object.hasOwn(message, 'industry')) {
        if (!$util.isString(message.industry)) { return 'industry: string expected' }
      }
      if (message.isActive != null && Object.hasOwn(message, 'isActive')) {
        if (typeof message.isActive !== 'boolean') { return 'isActive: boolean expected' }
      }
      if (
        message.memberUserIds != null &&
				Object.hasOwn(message, 'memberUserIds')
      ) {
        if (!Array.isArray(message.memberUserIds)) { return 'memberUserIds: array expected' }
        for (let i = 0; i < message.memberUserIds.length; i += 1) {
          if (!$util.isString(message.memberUserIds[i])) { return 'memberUserIds: string[] expected' }
        }
      }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) {
        if (!$util.isString(message.createdAt)) { return 'createdAt: string expected' }
      }
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) {
    ...
    CompanyProto.fromObject = function fromObject (object) {
      ...
      if (object.companyType != null) { message.companyType = String(object.companyType) }
      if (object.size != null) {
      ...
      if (object.memberUserIds) {
        if (!Array.isArray(object.memberUserIds)) {
          throw TypeError(
            '.company.CompanyProto.memberUserIds: array expected'
          )
        }
        message.memberUserIds = []
        for (let i = 0; i < object.memberUserIds.length; i += 1) { message.memberUserIds[i] = String(object.memberUserIds[i]) }
      }
    ...
    CompanyProto.toObject = function toObject (message, options) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { object.id = message.id }
      if (message.name != null && Object.hasOwn(message, 'name')) { object.name = message.name }
      if (message.logoUrl != null && Object.hasOwn(message, 'logoUrl')) { object.logoUrl = message.logoUrl }
      if (message.description != null && Object.hasOwn(message, 'description')) { object.description = message.description }
      if (message.website != null && Object.hasOwn(message, 'website')) { object.website = message.website }
      if (message.address != null && Object.hasOwn(message, 'address')) { object.address = message.address }
      if (message.phone != null && Object.hasOwn(message, 'phone')) { object.phone = message.phone }
      if (message.email != null && Object.hasOwn(message, 'email')) { object.email = message.email }
      if (message.companyType != null && Object.hasOwn(message, 'companyType')) { object.companyType = message.companyType }
      if (message.size != null && Object.hasOwn(message, 'size')) { object.size = message.size }
      if (message.industry != null && Object.hasOwn(message, 'industry')) { object.industry = message.industry }
      if (message.isActive != null && Object.hasOwn(message, 'isActive')) { object.isActive = message.isActive }
      if (message.memberUserIds && message.memberUserIds.length) {
        object.memberUserIds = []
        for (let j = 0; j < message.memberUserIds.length; j += 1) { object.memberUserIds[j] = message.memberUserIds[j] }
      }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { object.createdAt = message.createdAt }
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) { object.updatedAt = message.updatedAt }
      return object
    }
  ...
  company.CompanyMembershipProto = (() => {
    ...
    CompanyMembershipProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (message.companyId != null && Object.hasOwn(message, 'companyId')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.companyId) }
      if (message.userId != null && Object.hasOwn(message, 'userId')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.userId) }
      if (message.role != null && Object.hasOwn(message, 'role')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.role) }
      if (message.department != null && Object.hasOwn(message, 'department')) { writer.uint32(/* id 5, wireType 2 = */ 42).string(message.department) }
      if (message.position != null && Object.hasOwn(message, 'position')) { writer.uint32(/* id 6, wireType 2 = */ 50).string(message.position) }
      if (message.dateJoined != null && Object.hasOwn(message, 'dateJoined')) { writer.uint32(/* id 7, wireType 2 = */ 58).string(message.dateJoined) }
      if (message.isPrimary != null && Object.hasOwn(message, 'isPrimary')) { writer.uint32(/* id 8, wireType 0 = */ 64).bool(message.isPrimary) }
      return writer
    }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    CompanyMembershipProto.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    CompanyMembershipProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.company.CompanyMembershipProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    CompanyMembershipProto.verify = function verify (message) {
      ...
      if (message.companyId != null && Object.hasOwn(message, 'companyId')) {
        if (!$util.isString(message.companyId)) { return 'companyId: string expected' }
      }
      if (message.userId != null && Object.hasOwn(message, 'userId')) { if (!$util.isString(message.userId)) {
        return 'userId: string expected' ;
      }}
      if (message.role != null && Object.hasOwn(message, 'role')) { if (!$util.isString(message.role)) {
        return 'role: string expected' ;
      }}
      if (message.department != null && Object.hasOwn(message, 'department')) {
      ...
      if (message.position != null && Object.hasOwn(message, 'position')) {
        if (!$util.isString(message.position)) { return 'position: string expected' }
      }
      if (message.dateJoined != null && Object.hasOwn(message, 'dateJoined')) {
        if (!$util.isString(message.dateJoined)) { return 'dateJoined: string expected' }
      }
      if (message.isPrimary != null && Object.hasOwn(message, 'isPrimary')) {
        if (typeof message.isPrimary !== 'boolean') { return 'isPrimary: boolean expected' }
      }
      return null
    }
    ...
    CompanyMembershipProto.fromObject = function fromObject (object) {
      ...
      if (object.companyId != null) { message.companyId = String(object.companyId) }
      ...
      if (object.department != null) { message.department = String(object.department) }
      if (object.position != null) {
        message.position = String(object.position);
      }
      if (object.dateJoined != null) { message.dateJoined = String(object.dateJoined) }
      if (object.isPrimary != null) { message.isPrimary = Boolean(object.isPrimary) }
      return message
    }
    ...
    CompanyMembershipProto.toObject = function toObject (message, options) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { object.id = message.id }
      if (message.companyId != null && Object.hasOwn(message, 'companyId')) { object.companyId = message.companyId }
      if (message.userId != null && Object.hasOwn(message, 'userId')) { object.userId = message.userId }
      if (message.role != null && Object.hasOwn(message, 'role')) { object.role = message.role }
      if (message.department != null && Object.hasOwn(message, 'department')) { object.department = message.department }
      if (message.position != null && Object.hasOwn(message, 'position')) { object.position = message.position }
      if (message.dateJoined != null && Object.hasOwn(message, 'dateJoined')) { object.dateJoined = message.dateJoined }
      if (message.isPrimary != null && Object.hasOwn(message, 'isPrimary')) { object.isPrimary = message.isPrimary }
      return object
    }
  ...
  company.CompanyDocumentProto = (() => {
    ...
    CompanyDocumentProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (message.companyId != null && Object.hasOwn(message, 'companyId')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.companyId) }
      if (message.name != null && Object.hasOwn(message, 'name')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.name) }
      if (message.description != null && Object.hasOwn(message, 'description')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.description) }
      if (message.fileUrl != null && Object.hasOwn(message, 'fileUrl')) { writer.uint32(/* id 5, wireType 2 = */ 42).string(message.fileUrl) }
      if (
        message.documentType != null &&
				Object.hasOwn(message, 'documentType')
      ) { writer.uint32(/* id 6, wireType 2 = */ 50).string(message.documentType) }
      if (
        message.uploadedByUserId != null &&
				Object.hasOwn(message, 'uploadedByUserId')
      ) {
        writer
          .uint32(/* id 7, wireType 2 = */ 58)
          .string(message.uploadedByUserId)
      }
      if (message.uploadedAt != null && Object.hasOwn(message, 'uploadedAt')) { writer.uint32(/* id 8, wireType 2 = */ 66).string(message.uploadedAt) }
      return writer
    }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    CompanyDocumentProto.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    CompanyDocumentProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.company.CompanyDocumentProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    CompanyDocumentProto.verify = function verify (message) {
      ...
      if (message.fileUrl != null && Object.hasOwn(message, 'fileUrl')) { if (!$util.isString(message.fileUrl)) {
      ...
      if (
        ...
        if (!$util.isString(message.documentType)) { return 'documentType: string expected' }
      }
      if (
        message.uploadedByUserId != null &&
				Object.hasOwn(message, 'uploadedByUserId')
      ) {
        if (!$util.isString(message.uploadedByUserId)) { return 'uploadedByUserId: string expected' }
      }
      if (message.uploadedAt != null && Object.hasOwn(message, 'uploadedAt')) {
        if (!$util.isString(message.uploadedAt)) { return 'uploadedAt: string expected' }
      }
      return null
    }
    ...
    CompanyDocumentProto.fromObject = function fromObject (object) {
      ...
      if (object.documentType != null) { message.documentType = String(object.documentType) }
      if (object.uploadedByUserId != null) { message.uploadedByUserId = String(object.uploadedByUserId) }
      if (object.uploadedAt != null) { message.uploadedAt = String(object.uploadedAt) }
      return message
    }
    ...
    CompanyDocumentProto.toObject = function toObject (message, options) {
      ...
      if (message.name != null && Object.hasOwn(message, 'name')) { object.name = message.name }
      if (message.description != null && Object.hasOwn(message, 'description')) { object.description = message.description }
      if (message.fileUrl != null && Object.hasOwn(message, 'fileUrl')) { object.fileUrl = message.fileUrl }
      if (
        message.documentType != null &&
				Object.hasOwn(message, 'documentType')
      ...
      if (message.uploadedAt != null && Object.hasOwn(message, 'uploadedAt')) { object.uploadedAt = message.uploadedAt }
      return object
    }
  ...
  company.CompanyCollection = (() => {
    ...
    CompanyCollection.encode = function encode (message, writer) {
      ...
      if (message.companies != null && message.companies.length) {
        for (let i = 0; i < message.companies.length; i += 1) {
          $root.company.CompanyProto.encode(
            message.companies[i],
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    CompanyCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    CompanyCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.company.CompanyCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.companies && message.companies.length)) { message.companies = [] }
            message.companies.push(
              $root.company.CompanyProto.decode(reader, reader.uint32())
            )
            break
          }
          default:
    ...
    CompanyCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.companies != null && Object.hasOwn(message, 'companies')) {
        if (!Array.isArray(message.companies)) { return 'companies: array expected' }
        for (let i = 0; i < message.companies.length; i += 1) {
          const error = $root.company.CompanyProto.verify(message.companies[i])
          if (error) {
    ...
    CompanyCollection.fromObject = function fromObject (object) {
      ...
      if (object.companies) {
        if (!Array.isArray(object.companies)) {
          throw TypeError(
            '.company.CompanyCollection.companies: array expected'
          )
        }
        message.companies = []
        for (let i = 0; i < object.companies.length; i += 1) {
          if (typeof object.companies[i] !== 'object') {
            throw TypeError(
              '.company.CompanyCollection.companies: object expected'
            )
          }
          message.companies[i] = $root.company.CompanyProto.fromObject(
            object.companies[i]
          )
        }
      }
    ...
    CompanyCollection.toObject = function toObject (message, options) {
      ...
      if (message.companies && message.companies.length) {
        object.companies = []
        for (let j = 0; j < message.companies.length; j += 1) {
          object.companies[j] = $root.company.CompanyProto.toObject(
            message.companies[j],
            options
          )
        }
  ...
  company.CompanyMembershipCollection = (() => {
    ...
    CompanyMembershipCollection.encode = function encode (message, writer) {
      ...
      if (message.memberships != null && message.memberships.length) {
        for (let i = 0; i < message.memberships.length; i += 1) {
          $root.company.CompanyMembershipProto.encode(
            message.memberships[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
      }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    CompanyMembershipCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    CompanyMembershipCollection.decode = function decode (
      reader,
      length,
      error
    ) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.company.CompanyMembershipCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.memberships && message.memberships.length)) { message.memberships = [] }
            message.memberships.push(
              $root.company.CompanyMembershipProto.decode(
                reader,
                reader.uint32()
              )
            )
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    CompanyMembershipCollection.decodeDelimited = function decodeDelimited (
      reader
    ) {
      if (!(reader instanceof $Reader)) {
        reader = new $Reader(reader);
    ...
    CompanyMembershipCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (
        message.memberships != null &&
				Object.hasOwn(message, 'memberships')
      ) {
        if (!Array.isArray(message.memberships)) { return 'memberships: array expected' }
        for (let i = 0; i < message.memberships.length; i += 1) {
          const error = $root.company.CompanyMembershipProto.verify(
            message.memberships[i]
          )
          if (error) {
    ...
    CompanyMembershipCollection.fromObject = function fromObject (object) {
      if (object instanceof $root.company.CompanyMembershipCollection) { return object }
      const message = new $root.company.CompanyMembershipCollection()
      if (object.memberships) {
        if (!Array.isArray(object.memberships)) {
          throw TypeError(
            '.company.CompanyMembershipCollection.memberships: array expected'
          )
        }
        message.memberships = []
        for (let i = 0; i < object.memberships.length; i += 1) {
          if (typeof object.memberships[i] !== 'object') {
            throw TypeError(
              '.company.CompanyMembershipCollection.memberships: object expected'
            )
          }
          message.memberships[i] =
						$root.company.CompanyMembershipProto.fromObject(
    ...
    CompanyMembershipCollection.toObject = function toObject (message, options) {
      ...
      if (message.memberships && message.memberships.length) {
        object.memberships = []
        for (let j = 0; j < message.memberships.length; j += 1) {
          object.memberships[j] = $root.company.CompanyMembershipProto.toObject(
            message.memberships[j],
            options
          )
        }
      }
    ...
    /**
		 ...
		 * @returns {string} The default type url
		 */
    CompanyMembershipCollection.getTypeUrl = function getTypeUrl (
      typeUrlPrefix
    ) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = 'type.googleapis.com'
  ...
  company.CompanyDocumentCollection = (() => {
    ...
    CompanyDocumentCollection.encode = function encode (message, writer) {
      ...
      if (message.documents != null && message.documents.length) {
        for (let i = 0; i < message.documents.length; i += 1) {
          $root.company.CompanyDocumentProto.encode(
            message.documents[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    CompanyDocumentCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    CompanyDocumentCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.company.CompanyDocumentCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.documents && message.documents.length)) { message.documents = [] }
            message.documents.push(
              $root.company.CompanyDocumentProto.decode(
                reader,
                reader.uint32()
              )
            )
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    CompanyDocumentCollection.decodeDelimited = function decodeDelimited (
      reader
    ) {
      if (!(reader instanceof $Reader)) {
        reader = new $Reader(reader);
    ...
    CompanyDocumentCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.documents != null && Object.hasOwn(message, 'documents')) {
        if (!Array.isArray(message.documents)) { return 'documents: array expected' }
        for (let i = 0; i < message.documents.length; i += 1) {
          const error = $root.company.CompanyDocumentProto.verify(
            message.documents[i]
          )
          if (error) {
    ...
    CompanyDocumentCollection.fromObject = function fromObject (object) {
      if (object instanceof $root.company.CompanyDocumentCollection) { return object }
      const message = new $root.company.CompanyDocumentCollection()
      if (object.documents) {
        if (!Array.isArray(object.documents)) {
          throw TypeError(
            '.company.CompanyDocumentCollection.documents: array expected'
          )
        }
        message.documents = []
        for (let i = 0; i < object.documents.length; i += 1) {
          if (typeof object.documents[i] !== 'object') {
            throw TypeError(
              '.company.CompanyDocumentCollection.documents: object expected'
            )
          }
          message.documents[i] = $root.company.CompanyDocumentProto.fromObject(
            object.documents[i]
          )
        }
      }
    ...
    CompanyDocumentCollection.toObject = function toObject (message, options) {
      ...
      if (message.documents && message.documents.length) {
        object.documents = []
        for (let j = 0; j < message.documents.length; j += 1) {
          object.documents[j] = $root.company.CompanyDocumentProto.toObject(
            message.documents[j],
            options
          )
        }
...
$root.projects = (() => {
  ...
  projects.ProjectProto = (() => {
    ...
    ProjectProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (message.name != null && Object.hasOwn(message, 'name')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.name) }
      if (message.description != null && Object.hasOwn(message, 'description')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.description) }
      if (message.memberUserIds != null && message.memberUserIds.length) {
        for (let i = 0; i < message.memberUserIds.length; i += 1) {
          writer
      ...
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 5, wireType 2 = */ 42).string(message.createdAt) }
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) { writer.uint32(/* id 6, wireType 2 = */ 50).string(message.updatedAt) }
      return writer
    }
    ...
    ProjectProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.projects.ProjectProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    ProjectProto.fromObject = function fromObject (object) {
      ...
      if (object.memberUserIds) {
        if (!Array.isArray(object.memberUserIds)) {
          throw TypeError(
            '.projects.ProjectProto.memberUserIds: array expected'
          )
        }
        message.memberUserIds = []
        for (let i = 0; i < object.memberUserIds.length; i += 1) { message.memberUserIds[i] = String(object.memberUserIds[i]) }
  ...
  projects.ProjectMembershipProto = (() => {
    ...
    ProjectMembershipProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (message.projectId != null && Object.hasOwn(message, 'projectId')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.projectId) }
      if (message.userId != null && Object.hasOwn(message, 'userId')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.userId) }
      if (message.role != null && Object.hasOwn(message, 'role')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.role) }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 5, wireType 2 = */ 42).string(message.createdAt) }
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) { writer.uint32(/* id 6, wireType 2 = */ 50).string(message.updatedAt) }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    ProjectMembershipProto.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    ProjectMembershipProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.projects.ProjectMembershipProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    ProjectMembershipProto.verify = function verify (message) {
      ...
      if (message.projectId != null && Object.hasOwn(message, 'projectId')) {
    ...
    ProjectMembershipProto.fromObject = function fromObject (object) {
      if (object instanceof $root.projects.ProjectMembershipProto) { return object }
      const message = new $root.projects.ProjectMembershipProto()
      if (object.id != null) {
        message.id = String(object.id);
      }
    ...
    ProjectMembershipProto.toObject = function toObject (message, options) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { object.id = message.id }
      if (message.projectId != null && Object.hasOwn(message, 'projectId')) { object.projectId = message.projectId }
      if (message.userId != null && Object.hasOwn(message, 'userId')) { object.userId = message.userId }
      if (message.role != null && Object.hasOwn(message, 'role')) { object.role = message.role }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { object.createdAt = message.createdAt }
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) { object.updatedAt = message.updatedAt }
  ...
  projects.ProjectObligationProto = (() => {
    ...
    ProjectObligationProto.encode = function encode (message, writer) {
      ...
      if (message.projectId != null && Object.hasOwn(message, 'projectId')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.projectId) }
      if (
        message.obligationId != null &&
				Object.hasOwn(message, 'obligationId')
      ) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.obligationId) }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.createdAt) }
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) { writer.uint32(/* id 5, wireType 2 = */ 42).string(message.updatedAt) }
      return writer
    }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    ProjectObligationProto.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    ProjectObligationProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.projects.ProjectObligationProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    ProjectObligationProto.verify = function verify (message) {
      ...
      if (
        ...
        if (!$util.isString(message.obligationId)) { return 'obligationId: string expected' }
      }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) {
        if (!$util.isString(message.createdAt)) { return 'createdAt: string expected' }
      }
    ...
    ProjectObligationProto.fromObject = function fromObject (object) {
      if (object instanceof $root.projects.ProjectObligationProto) { return object }
      const message = new $root.projects.ProjectObligationProto()
      if (object.id != null) {
        message.id = String(object.id);
      }
      if (object.projectId != null) { message.projectId = String(object.projectId) }
      if (object.obligationId != null) { message.obligationId = String(object.obligationId) }
      if (object.createdAt != null) { message.createdAt = String(object.createdAt) }
      if (object.updatedAt != null) { message.updatedAt = String(object.updatedAt) }
      return message
    }
  ...
  projects.ProjectCollection = (() => {
    ...
    ProjectCollection.encode = function encode (message, writer) {
      ...
      if (message.projects != null && message.projects.length) {
        for (let i = 0; i < message.projects.length; i += 1) {
          $root.projects.ProjectProto.encode(
            message.projects[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    ProjectCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    ProjectCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.projects.ProjectCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.projects && message.projects.length)) { message.projects = [] }
            message.projects.push(
              $root.projects.ProjectProto.decode(reader, reader.uint32())
            )
            break
          }
          default:
    ...
    ProjectCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.projects != null && Object.hasOwn(message, 'projects')) {
        if (!Array.isArray(message.projects)) {
          return 'projects: array expected';
        }
        for (let i = 0; i < message.projects.length; i += 1) {
          const error = $root.projects.ProjectProto.verify(message.projects[i])
          if (error) {
    ...
    ProjectCollection.fromObject = function fromObject (object) {
      ...
      if (object.projects) {
        if (!Array.isArray(object.projects)) {
          throw TypeError(
            '.projects.ProjectCollection.projects: array expected'
          )
        }
        message.projects = []
        for (let i = 0; i < object.projects.length; i += 1) {
          if (typeof object.projects[i] !== 'object') {
            throw TypeError(
              '.projects.ProjectCollection.projects: object expected'
            )
          }
          message.projects[i] = $root.projects.ProjectProto.fromObject(
            object.projects[i]
          )
        }
      }
    ...
    ProjectCollection.toObject = function toObject (message, options) {
      ...
      if (message.projects && message.projects.length) {
        object.projects = []
        for (let j = 0; j < message.projects.length; j += 1) {
          object.projects[j] = $root.projects.ProjectProto.toObject(
            message.projects[j],
            options
          )
        }
  ...
  projects.ProjectMembershipCollection = (() => {
    ...
    ProjectMembershipCollection.encode = function encode (message, writer) {
      ...
      if (message.memberships != null && message.memberships.length) {
        for (let i = 0; i < message.memberships.length; i += 1) {
          $root.projects.ProjectMembershipProto.encode(
            message.memberships[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    ProjectMembershipCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    ProjectMembershipCollection.decode = function decode (
      reader,
      length,
      error
    ) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.projects.ProjectMembershipCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.memberships && message.memberships.length)) { message.memberships = [] }
            message.memberships.push(
              $root.projects.ProjectMembershipProto.decode(
                reader,
                reader.uint32()
              )
            )
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    ProjectMembershipCollection.decodeDelimited = function decodeDelimited (
      reader
    ) {
      if (!(reader instanceof $Reader)) {
        reader = new $Reader(reader);
    ...
    ProjectMembershipCollection.verify = function verify (message) {
      ...
      if (
        ...
        if (!Array.isArray(message.memberships)) { return 'memberships: array expected' }
        for (let i = 0; i < message.memberships.length; i += 1) {
          const error = $root.projects.ProjectMembershipProto.verify(
            message.memberships[i]
          )
          if (error) {
            return 'memberships.' + error;
    ...
    ProjectMembershipCollection.fromObject = function fromObject (object) {
      if (object instanceof $root.projects.ProjectMembershipCollection) { return object }
      const message = new $root.projects.ProjectMembershipCollection()
      if (object.memberships) {
        if (!Array.isArray(object.memberships)) {
          throw TypeError(
            '.projects.ProjectMembershipCollection.memberships: array expected'
          )
        }
        message.memberships = []
        for (let i = 0; i < object.memberships.length; i += 1) {
          if (typeof object.memberships[i] !== 'object') {
            throw TypeError(
              '.projects.ProjectMembershipCollection.memberships: object expected'
            )
          }
          message.memberships[i] =
						$root.projects.ProjectMembershipProto.fromObject(
						  object.memberships[i]
						)
        }
      }
    ...
    ProjectMembershipCollection.toObject = function toObject (message, options) {
      ...
      if (message.memberships && message.memberships.length) {
        object.memberships = []
        for (let j = 0; j < message.memberships.length; j += 1) {
          object.memberships[j] =
						$root.projects.ProjectMembershipProto.toObject(
						  message.memberships[j],
						  options
						)
        }
    ...
    /**
		 ...
		 * @returns {string} The default type url
		 */
    ProjectMembershipCollection.getTypeUrl = function getTypeUrl (
      typeUrlPrefix
    ) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = 'type.googleapis.com'
  ...
  projects.ProjectObligationCollection = (() => {
    ...
    ProjectObligationCollection.encode = function encode (message, writer) {
      ...
      if (
        message.projectObligations != null &&
				message.projectObligations.length
      ) {
        for (let i = 0; i < message.projectObligations.length; i += 1) {
          $root.projects.ProjectObligationProto.encode(
            message.projectObligations[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
      }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    ProjectObligationCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    ProjectObligationCollection.decode = function decode (
      reader,
      length,
      error
    ) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.projects.ProjectObligationCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (
              !(message.projectObligations && message.projectObligations.length)
            ) { message.projectObligations = [] }
            message.projectObligations.push(
              $root.projects.ProjectObligationProto.decode(
                reader,
                reader.uint32()
              )
            )
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    ProjectObligationCollection.decodeDelimited = function decodeDelimited (
      reader
    ) {
      if (!(reader instanceof $Reader)) {
        reader = new $Reader(reader);
    ...
    ProjectObligationCollection.verify = function verify (message) {
      ...
      if (
        message.projectObligations != null &&
				Object.hasOwn(message, 'projectObligations')
      ) {
        if (!Array.isArray(message.projectObligations)) { return 'projectObligations: array expected' }
        for (let i = 0; i < message.projectObligations.length; i += 1) {
          const error = $root.projects.ProjectObligationProto.verify(
            message.projectObligations[i]
          )
          if (error) {
    ...
    ProjectObligationCollection.fromObject = function fromObject (object) {
      if (object instanceof $root.projects.ProjectObligationCollection) { return object }
      const message = new $root.projects.ProjectObligationCollection()
      if (object.projectObligations) {
        if (!Array.isArray(object.projectObligations)) {
          throw TypeError(
            '.projects.ProjectObligationCollection.projectObligations: array expected'
          )
        }
        message.projectObligations = []
        for (let i = 0; i < object.projectObligations.length; i += 1) {
          if (typeof object.projectObligations[i] !== 'object') {
            throw TypeError(
              '.projects.ProjectObligationCollection.projectObligations: object expected'
            )
          }
          message.projectObligations[i] =
						$root.projects.ProjectObligationProto.fromObject(
						  object.projectObligations[i]
						)
        }
      }
      return message
    ...
    ProjectObligationCollection.toObject = function toObject (message, options) {
      ...
      if (message.projectObligations && message.projectObligations.length) {
        object.projectObligations = []
        for (let j = 0; j < message.projectObligations.length; j += 1) {
          object.projectObligations[j] =
						$root.projects.ProjectObligationProto.toObject(
						  message.projectObligations[j],
						  options
						)
        }
      }
    ...
    /**
		 ...
		 * @returns {string} The default type url
		 */
    ProjectObligationCollection.getTypeUrl = function getTypeUrl (
      typeUrlPrefix
    ) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = 'type.googleapis.com'
...
$root.users = (() => {
  ...
  users.UserProto = (() => {
    ...
    UserProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (message.username != null && Object.hasOwn(message, 'username')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.username) }
      if (message.email != null && Object.hasOwn(message, 'email')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.email) }
      if (message.firstName != null && Object.hasOwn(message, 'firstName')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.firstName) }
      if (message.lastName != null && Object.hasOwn(message, 'lastName')) { writer.uint32(/* id 5, wireType 2 = */ 42).string(message.lastName) }
      if (message.isActive != null && Object.hasOwn(message, 'isActive')) { writer.uint32(/* id 6, wireType 0 = */ 48).bool(message.isActive) }
      if (message.dateJoined != null && Object.hasOwn(message, 'dateJoined')) { writer.uint32(/* id 7, wireType 2 = */ 58).string(message.dateJoined) }
      return writer
    }
    ...
    UserProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.users.UserProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    UserProto.verify = function verify (message) {
      ...
      if (message.username != null && Object.hasOwn(message, 'username')) {
        if (!$util.isString(message.username)) { return 'username: string expected' }
      }
      if (message.email != null && Object.hasOwn(message, 'email')) { if (!$util.isString(message.email)) {
        return 'email: string expected' ;
      }}
      if (message.firstName != null && Object.hasOwn(message, 'firstName')) {
        if (!$util.isString(message.firstName)) { return 'firstName: string expected' }
      }
      if (message.lastName != null && Object.hasOwn(message, 'lastName')) {
    ...
    UserProto.toObject = function toObject (message, options) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { object.id = message.id }
      if (message.username != null && Object.hasOwn(message, 'username')) { object.username = message.username }
      if (message.email != null && Object.hasOwn(message, 'email')) { object.email = message.email }
      if (message.firstName != null && Object.hasOwn(message, 'firstName')) { object.firstName = message.firstName }
      if (message.lastName != null && Object.hasOwn(message, 'lastName')) { object.lastName = message.lastName }
      if (message.isActive != null && Object.hasOwn(message, 'isActive')) { object.isActive = message.isActive }
      if (message.dateJoined != null && Object.hasOwn(message, 'dateJoined')) { object.dateJoined = message.dateJoined }
      return object
    }
  ...
  users.ProfileProto = (() => {
    ...
    ProfileProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (message.userId != null && Object.hasOwn(message, 'userId')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.userId) }
      if (message.bio != null && Object.hasOwn(message, 'bio')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.bio) }
      if (message.position != null && Object.hasOwn(message, 'position')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.position) }
      if (message.department != null && Object.hasOwn(message, 'department')) { writer.uint32(/* id 5, wireType 2 = */ 42).string(message.department) }
      if (message.phoneNumber != null && Object.hasOwn(message, 'phoneNumber')) { writer.uint32(/* id 6, wireType 2 = */ 50).string(message.phoneNumber) }
      if (
        message.profileImageUrl != null &&
				Object.hasOwn(message, 'profileImageUrl')
      ) {
        writer
          .uint32(/* id 7, wireType 2 = */ 58)
          .string(message.profileImageUrl)
      }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 8, wireType 2 = */ 66).string(message.createdAt) }
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) { writer.uint32(/* id 9, wireType 2 = */ 74).string(message.updatedAt) }
      return writer
    }
    ...
    ProfileProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.users.ProfileProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    ProfileProto.verify = function verify (message) {
      ...
      if (message.bio != null && Object.hasOwn(message, 'bio')) { if (!$util.isString(message.bio)) {
      ...
      if (message.phoneNumber != null && Object.hasOwn(message, 'phoneNumber')) {
      ...
      if (
        ...
        if (!$util.isString(message.profileImageUrl)) { return 'profileImageUrl: string expected' }
      }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) {
        if (!$util.isString(message.createdAt)) { return 'createdAt: string expected' }
      }
    ...
    ProfileProto.fromObject = function fromObject (object) {
      ...
      if (object.profileImageUrl != null) { message.profileImageUrl = String(object.profileImageUrl) }
      if (object.createdAt != null) { message.createdAt = String(object.createdAt) }
      if (object.updatedAt != null) { message.updatedAt = String(object.updatedAt) }
      return message
    }
    ...
    ProfileProto.toObject = function toObject (message, options) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { object.id = message.id }
      if (message.userId != null && Object.hasOwn(message, 'userId')) { object.userId = message.userId }
      if (message.bio != null && Object.hasOwn(message, 'bio')) { object.bio = message.bio }
      if (message.position != null && Object.hasOwn(message, 'position')) { object.position = message.position }
      if (message.department != null && Object.hasOwn(message, 'department')) { object.department = message.department }
      if (message.phoneNumber != null && Object.hasOwn(message, 'phoneNumber')) { object.phoneNumber = message.phoneNumber }
      if (
        message.profileImageUrl != null &&
				Object.hasOwn(message, 'profileImageUrl')
  ...
  users.UserCollection = (() => {
    ...
    UserCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.users.UserCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.users.push(
              $root.users.UserProto.decode(reader, reader.uint32())
            )
            break
          }
          default:
    ...
    UserCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.users != null && Object.hasOwn(message, 'users')) {
        if (!Array.isArray(message.users)) {
          return 'users: array expected';
        }
        for (let i = 0; i < message.users.length; i += 1) {
          const error = $root.users.UserProto.verify(message.users[i])
          if (error) {
            return 'users.' + error;
          }
        }
    ...
    UserCollection.fromObject = function fromObject (object) {
      ...
      const message = new $root.users.UserCollection()
      if (object.users) {
        if (!Array.isArray(object.users)) { throw TypeError('.users.UserCollection.users: array expected') }
        message.users = []
        for (let i = 0; i < object.users.length; i += 1) {
          if (typeof object.users[i] !== 'object') { throw TypeError('.users.UserCollection.users: object expected') }
    ...
    UserCollection.toObject = function toObject (message, options) {
      ...
      if (message.users && message.users.length) {
        object.users = []
        for (let j = 0; j < message.users.length; j += 1) {
          object.users[j] = $root.users.UserProto.toObject(
            message.users[j],
            options
          )
        }
  ...
  users.ProfileCollection = (() => {
    ...
    ProfileCollection.encode = function encode (message, writer) {
      ...
      if (message.profiles != null && message.profiles.length) {
        for (let i = 0; i < message.profiles.length; i += 1) {
          $root.users.ProfileProto.encode(
            message.profiles[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    ProfileCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    ProfileCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.users.ProfileCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.profiles && message.profiles.length)) { message.profiles = [] }
            message.profiles.push(
              $root.users.ProfileProto.decode(reader, reader.uint32())
            )
            break
          }
          default:
    ...
    ProfileCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.profiles != null && Object.hasOwn(message, 'profiles')) {
        if (!Array.isArray(message.profiles)) {
          return 'profiles: array expected';
        }
        for (let i = 0; i < message.profiles.length; i += 1) {
          const error = $root.users.ProfileProto.verify(message.profiles[i])
          if (error) {
    ...
    ProfileCollection.fromObject = function fromObject (object) {
      ...
      const message = new $root.users.ProfileCollection()
      if (object.profiles) {
        if (!Array.isArray(object.profiles)) { throw TypeError('.users.ProfileCollection.profiles: array expected') }
        message.profiles = []
        for (let i = 0; i < object.profiles.length; i += 1) {
          if (typeof object.profiles[i] !== 'object') {
            throw TypeError(
              '.users.ProfileCollection.profiles: object expected'
            )
          }
          message.profiles[i] = $root.users.ProfileProto.fromObject(
            object.profiles[i]
          )
        }
      }
    ...
    ProfileCollection.toObject = function toObject (message, options) {
      ...
      if (message.profiles && message.profiles.length) {
        object.profiles = []
        for (let j = 0; j < message.profiles.length; j += 1) {
          object.profiles[j] = $root.users.ProfileProto.toObject(
            message.profiles[j],
            options
          )
        }
...
$root.auditing = (() => {
  ...
  auditing.MitigationProto = (() => {
    ...
    MitigationProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (
        message.auditEntryId != null &&
				Object.hasOwn(message, 'auditEntryId')
      ) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.auditEntryId) }
      if (message.description != null && Object.hasOwn(message, 'description')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.description) }
      if (message.status != null && Object.hasOwn(message, 'status')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.status) }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 5, wireType 2 = */ 42).string(message.createdAt) }
      return writer
    }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    MitigationProto.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    MitigationProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.MitigationProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    MitigationProto.verify = function verify (message) {
      ...
      if (
        ...
        if (!$util.isString(message.auditEntryId)) { return 'auditEntryId: string expected' }
      }
      if (message.description != null && Object.hasOwn(message, 'description')) {
        if (!$util.isString(message.description)) { return 'description: string expected' }
      }
      if (message.status != null && Object.hasOwn(message, 'status')) { if (!$util.isString(message.status)) {
    ...
    MitigationProto.fromObject = function fromObject (object) {
      ...
      if (object.auditEntryId != null) { message.auditEntryId = String(object.auditEntryId) }
      if (object.description != null) { message.description = String(object.description) }
    ...
    MitigationProto.toObject = function toObject (message, options) {
      ...
      if (message.description != null && Object.hasOwn(message, 'description')) { object.description = message.description }
      if (message.status != null && Object.hasOwn(message, 'status')) { object.status = message.status }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { object.createdAt = message.createdAt }
      return object
    }
  ...
  auditing.CorrectiveActionProto = (() => {
    ...
    CorrectiveActionProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (
        message.mitigationId != null &&
				Object.hasOwn(message, 'mitigationId')
      ) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.mitigationId) }
      if (message.task != null && Object.hasOwn(message, 'task')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.task) }
      if (message.status != null && Object.hasOwn(message, 'status')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.status) }
      if (
        message.assignedToUserId != null &&
				Object.hasOwn(message, 'assignedToUserId')
      ) {
        writer
          .uint32(/* id 5, wireType 2 = */ 42)
          .string(message.assignedToUserId)
      }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 6, wireType 2 = */ 50).string(message.createdAt) }
      if (message.dueDate != null && Object.hasOwn(message, 'dueDate')) { writer.uint32(/* id 7, wireType 2 = */ 58).string(message.dueDate) }
      return writer
    }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    CorrectiveActionProto.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    CorrectiveActionProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.CorrectiveActionProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    CorrectiveActionProto.verify = function verify (message) {
      ...
      if (
        ...
        if (!$util.isString(message.mitigationId)) { return 'mitigationId: string expected' }
      }
      if (message.task != null && Object.hasOwn(message, 'task')) { if (!$util.isString(message.task)) {
      ...
      if (
        ...
        if (!$util.isString(message.assignedToUserId)) { return 'assignedToUserId: string expected' }
      }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) {
        if (!$util.isString(message.createdAt)) { return 'createdAt: string expected' }
      }
      if (message.dueDate != null && Object.hasOwn(message, 'dueDate')) { if (!$util.isString(message.dueDate)) {
    ...
    CorrectiveActionProto.fromObject = function fromObject (object) {
      ...
      if (object.mitigationId != null) { message.mitigationId = String(object.mitigationId) }
      if (object.task != null) {
      ...
      if (object.assignedToUserId != null) { message.assignedToUserId = String(object.assignedToUserId) }
      if (object.createdAt != null) { message.createdAt = String(object.createdAt) }
    ...
    CorrectiveActionProto.toObject = function toObject (message, options) {
      ...
      if (message.task != null && Object.hasOwn(message, 'task')) { object.task = message.task }
      if (message.status != null && Object.hasOwn(message, 'status')) { object.status = message.status }
      if (
        message.assignedToUserId != null &&
				Object.hasOwn(message, 'assignedToUserId')
      ...
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { object.createdAt = message.createdAt }
      if (message.dueDate != null && Object.hasOwn(message, 'dueDate')) { object.dueDate = message.dueDate }
      return object
    }
  ...
  auditing.AuditProto = (() => {
    ...
    AuditProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (message.name != null && Object.hasOwn(message, 'name')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.name) }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.createdAt) }
      if (message.mechanismIds != null && message.mechanismIds.length) {
        for (let i = 0; i < message.mechanismIds.length; i += 1) {
          writer
            .uint32(/* id 4, wireType 2 = */ 34)
            .string(message.mechanismIds[i])
        }
      }
      return writer
    }
    ...
    AuditProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.AuditProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          ...
          case 4: {
            if (!(message.mechanismIds && message.mechanismIds.length)) { message.mechanismIds = [] }
    ...
    AuditProto.verify = function verify (message) {
      ...
      if (
        message.mechanismIds != null &&
				Object.hasOwn(message, 'mechanismIds')
      ) {
        if (!Array.isArray(message.mechanismIds)) { return 'mechanismIds: array expected' }
        for (let i = 0; i < message.mechanismIds.length; i += 1) {
          if (!$util.isString(message.mechanismIds[i])) { return 'mechanismIds: string[] expected' }
        }
      }
      return null
    }
    ...
    AuditProto.fromObject = function fromObject (object) {
      ...
      if (object.mechanismIds) {
        if (!Array.isArray(object.mechanismIds)) { throw TypeError('.auditing.AuditProto.mechanismIds: array expected') }
        message.mechanismIds = []
        for (let i = 0; i < object.mechanismIds.length; i += 1) { message.mechanismIds[i] = String(object.mechanismIds[i]) }
      }
      return message
    }
    ...
    AuditProto.toObject = function toObject (message, options) {
      ...
      if (message.mechanismIds && message.mechanismIds.length) {
        object.mechanismIds = []
        for (let j = 0; j < message.mechanismIds.length; j += 1) { object.mechanismIds[j] = message.mechanismIds[j] }
      }
      return object
    }
  ...
  auditing.AuditEntryProto = (() => {
    ...
    AuditEntryProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.id) }
      if (message.auditId != null && Object.hasOwn(message, 'auditId')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.auditId) }
      if (
        message.obligationId != null &&
				Object.hasOwn(message, 'obligationId')
      ) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.obligationId) }
      if (message.status != null && Object.hasOwn(message, 'status')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.status) }
      if (message.finding != null && Object.hasOwn(message, 'finding')) { writer.uint32(/* id 5, wireType 2 = */ 42).string(message.finding) }
      return writer
    }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    AuditEntryProto.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    AuditEntryProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.AuditEntryProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    AuditEntryProto.verify = function verify (message) {
      ...
      if (message.auditId != null && Object.hasOwn(message, 'auditId')) { if (!$util.isString(message.auditId)) {
      ...
      if (message.finding != null && Object.hasOwn(message, 'finding')) { if (!$util.isString(message.finding)) {
    ...
    AuditEntryProto.toObject = function toObject (message, options) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { object.id = message.id }
      if (message.auditId != null && Object.hasOwn(message, 'auditId')) { object.auditId = message.auditId }
      if (
        message.obligationId != null &&
				Object.hasOwn(message, 'obligationId')
      ) { object.obligationId = message.obligationId }
      if (message.status != null && Object.hasOwn(message, 'status')) { object.status = message.status }
      if (message.finding != null && Object.hasOwn(message, 'finding')) { object.finding = message.finding }
      return object
    }
  ...
  auditing.ComplianceCommentProto = (() => {
    ...
    ComplianceCommentProto.encode = function encode (message, writer) {
      ...
      if (message.text != null && Object.hasOwn(message, 'text')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.text) }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.createdAt) }
      return writer
    }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    ComplianceCommentProto.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    ComplianceCommentProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.ComplianceCommentProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    ComplianceCommentProto.verify = function verify (message) {
      ...
      if (message.text != null && Object.hasOwn(message, 'text')) { if (!$util.isString(message.text)) {
    ...
    ComplianceCommentProto.fromObject = function fromObject (object) {
      if (object instanceof $root.auditing.ComplianceCommentProto) { return object }
      const message = new $root.auditing.ComplianceCommentProto()
      if (object.id != null) {
        message.id = String(object.id);
      }
    ...
    ComplianceCommentProto.toObject = function toObject (message, options) {
      ...
      if (message.text != null && Object.hasOwn(message, 'text')) { object.text = message.text }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { object.createdAt = message.createdAt }
      return object
    }
  ...
  auditing.NonConformanceCommentProto = (() => {
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    NonConformanceCommentProto.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    NonConformanceCommentProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.NonConformanceCommentProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    NonConformanceCommentProto.decodeDelimited = function decodeDelimited (
      reader
    ) {
      if (!(reader instanceof $Reader)) {
        reader = new $Reader(reader);
    ...
    NonConformanceCommentProto.fromObject = function fromObject (object) {
      if (object instanceof $root.auditing.NonConformanceCommentProto) { return object }
      const message = new $root.auditing.NonConformanceCommentProto()
      if (object.id != null) {
        message.id = String(object.id);
      }
  ...
  auditing.MitigationCollection = (() => {
    ...
    MitigationCollection.encode = function encode (message, writer) {
      ...
      if (message.mitigations != null && message.mitigations.length) {
        for (let i = 0; i < message.mitigations.length; i += 1) {
          $root.auditing.MitigationProto.encode(
            message.mitigations[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
      }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    MitigationCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    MitigationCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.MitigationCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.mitigations && message.mitigations.length)) { message.mitigations = [] }
            message.mitigations.push(
              $root.auditing.MitigationProto.decode(reader, reader.uint32())
            )
            break
          }
          default:
    ...
    MitigationCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (
        message.mitigations != null &&
				Object.hasOwn(message, 'mitigations')
      ) {
        if (!Array.isArray(message.mitigations)) { return 'mitigations: array expected' }
        for (let i = 0; i < message.mitigations.length; i += 1) {
          const error = $root.auditing.MitigationProto.verify(
            message.mitigations[i]
          )
          if (error) {
    ...
    MitigationCollection.fromObject = function fromObject (object) {
      ...
      if (object.mitigations) {
        if (!Array.isArray(object.mitigations)) {
          throw TypeError(
            '.auditing.MitigationCollection.mitigations: array expected'
          )
        }
        message.mitigations = []
        for (let i = 0; i < object.mitigations.length; i += 1) {
          if (typeof object.mitigations[i] !== 'object') {
            throw TypeError(
              '.auditing.MitigationCollection.mitigations: object expected'
            )
          }
          message.mitigations[i] = $root.auditing.MitigationProto.fromObject(
            object.mitigations[i]
          )
        }
      }
      return message
    ...
    MitigationCollection.toObject = function toObject (message, options) {
      ...
      if (message.mitigations && message.mitigations.length) {
        object.mitigations = []
        for (let j = 0; j < message.mitigations.length; j += 1) {
          object.mitigations[j] = $root.auditing.MitigationProto.toObject(
            message.mitigations[j],
            options
          )
        }
      }
  ...
  auditing.CorrectiveActionCollection = (() => {
    ...
    CorrectiveActionCollection.encode = function encode (message, writer) {
      ...
      if (message.correctiveActions != null && message.correctiveActions.length) {
        for (let i = 0; i < message.correctiveActions.length; i += 1) {
          $root.auditing.CorrectiveActionProto.encode(
            message.correctiveActions[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
      }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    CorrectiveActionCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    CorrectiveActionCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.CorrectiveActionCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (
              !(message.correctiveActions && message.correctiveActions.length)
            ) { message.correctiveActions = [] }
            message.correctiveActions.push(
              $root.auditing.CorrectiveActionProto.decode(
                reader,
                reader.uint32()
              )
            )
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    CorrectiveActionCollection.decodeDelimited = function decodeDelimited (
      reader
    ) {
      if (!(reader instanceof $Reader)) {
        reader = new $Reader(reader);
    ...
    CorrectiveActionCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (
        message.correctiveActions != null &&
				Object.hasOwn(message, 'correctiveActions')
      ) {
        if (!Array.isArray(message.correctiveActions)) { return 'correctiveActions: array expected' }
        for (let i = 0; i < message.correctiveActions.length; i += 1) {
          const error = $root.auditing.CorrectiveActionProto.verify(
            message.correctiveActions[i]
          )
          if (error) {
    ...
    CorrectiveActionCollection.fromObject = function fromObject (object) {
      if (object instanceof $root.auditing.CorrectiveActionCollection) { return object }
      const message = new $root.auditing.CorrectiveActionCollection()
      if (object.correctiveActions) {
        if (!Array.isArray(object.correctiveActions)) {
          throw TypeError(
            '.auditing.CorrectiveActionCollection.correctiveActions: array expected'
          )
        }
        message.correctiveActions = []
        for (let i = 0; i < object.correctiveActions.length; i += 1) {
          if (typeof object.correctiveActions[i] !== 'object') {
            throw TypeError(
              '.auditing.CorrectiveActionCollection.correctiveActions: object expected'
            )
          }
          message.correctiveActions[i] =
						$root.auditing.CorrectiveActionProto.fromObject(
						  object.correctiveActions[i]
						)
        }
      }
      return message
    ...
    CorrectiveActionCollection.toObject = function toObject (message, options) {
      ...
      if (message.correctiveActions && message.correctiveActions.length) {
        object.correctiveActions = []
        for (let j = 0; j < message.correctiveActions.length; j += 1) {
          object.correctiveActions[j] =
						$root.auditing.CorrectiveActionProto.toObject(
						  message.correctiveActions[j],
						  options
						)
        }
      }
  ...
  auditing.AuditCollection = (() => {
    ...
    AuditCollection.encode = function encode (message, writer) {
      ...
      if (message.audits != null && message.audits.length) {
        for (let i = 0; i < message.audits.length; i += 1) {
          $root.auditing.AuditProto.encode(
            message.audits[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    AuditCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    AuditCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.AuditCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.audits.push(
              $root.auditing.AuditProto.decode(reader, reader.uint32())
            )
            break
          }
          default:
    ...
    AuditCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.audits != null && Object.hasOwn(message, 'audits')) {
        if (!Array.isArray(message.audits)) {
          return 'audits: array expected';
        }
        for (let i = 0; i < message.audits.length; i += 1) {
          const error = $root.auditing.AuditProto.verify(message.audits[i])
          if (error) {
            return 'audits.' + error;
          }
        }
    ...
    AuditCollection.fromObject = function fromObject (object) {
      ...
      const message = new $root.auditing.AuditCollection()
      if (object.audits) {
        if (!Array.isArray(object.audits)) { throw TypeError('.auditing.AuditCollection.audits: array expected') }
        message.audits = []
        for (let i = 0; i < object.audits.length; i += 1) {
          if (typeof object.audits[i] !== 'object') {
            throw TypeError(
              '.auditing.AuditCollection.audits: object expected'
            )
          }
          message.audits[i] = $root.auditing.AuditProto.fromObject(
            object.audits[i]
          )
        }
      }
    ...
    AuditCollection.toObject = function toObject (message, options) {
      ...
      if (message.audits && message.audits.length) {
        object.audits = []
        for (let j = 0; j < message.audits.length; j += 1) {
          object.audits[j] = $root.auditing.AuditProto.toObject(
            message.audits[j],
            options
          )
        }
  ...
  auditing.AuditEntryCollection = (() => {
    ...
    AuditEntryCollection.encode = function encode (message, writer) {
      ...
      if (message.auditEntries != null && message.auditEntries.length) {
        for (let i = 0; i < message.auditEntries.length; i += 1) {
          $root.auditing.AuditEntryProto.encode(
            message.auditEntries[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
      }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    AuditEntryCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    AuditEntryCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.AuditEntryCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.auditEntries && message.auditEntries.length)) { message.auditEntries = [] }
            message.auditEntries.push(
              $root.auditing.AuditEntryProto.decode(reader, reader.uint32())
            )
            break
          }
          default:
    ...
    AuditEntryCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (
        message.auditEntries != null &&
				Object.hasOwn(message, 'auditEntries')
      ) {
        if (!Array.isArray(message.auditEntries)) { return 'auditEntries: array expected' }
        for (let i = 0; i < message.auditEntries.length; i += 1) {
          const error = $root.auditing.AuditEntryProto.verify(
            message.auditEntries[i]
          )
          if (error) {
    ...
    AuditEntryCollection.fromObject = function fromObject (object) {
      ...
      if (object.auditEntries) {
        if (!Array.isArray(object.auditEntries)) {
          throw TypeError(
            '.auditing.AuditEntryCollection.auditEntries: array expected'
          )
        }
        message.auditEntries = []
        for (let i = 0; i < object.auditEntries.length; i += 1) {
          if (typeof object.auditEntries[i] !== 'object') {
            throw TypeError(
              '.auditing.AuditEntryCollection.auditEntries: object expected'
            )
          }
          message.auditEntries[i] = $root.auditing.AuditEntryProto.fromObject(
            object.auditEntries[i]
          )
        }
      }
      return message
    ...
    AuditEntryCollection.toObject = function toObject (message, options) {
      ...
      if (message.auditEntries && message.auditEntries.length) {
        object.auditEntries = []
        for (let j = 0; j < message.auditEntries.length; j += 1) {
          object.auditEntries[j] = $root.auditing.AuditEntryProto.toObject(
            message.auditEntries[j],
            options
          )
        }
      }
  ...
  auditing.ComplianceCommentCollection = (() => {
    ...
    ComplianceCommentCollection.encode = function encode (message, writer) {
      ...
      if (
        message.complianceComments != null &&
				message.complianceComments.length
      ) {
        for (let i = 0; i < message.complianceComments.length; i += 1) {
          $root.auditing.ComplianceCommentProto.encode(
            message.complianceComments[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
      }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    ComplianceCommentCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    ComplianceCommentCollection.decode = function decode (
      reader,
      length,
      error
    ) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.ComplianceCommentCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (
              !(message.complianceComments && message.complianceComments.length)
            ) { message.complianceComments = [] }
            message.complianceComments.push(
              $root.auditing.ComplianceCommentProto.decode(
                reader,
                reader.uint32()
              )
            )
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    ComplianceCommentCollection.decodeDelimited = function decodeDelimited (
      reader
    ) {
      if (!(reader instanceof $Reader)) {
        reader = new $Reader(reader);
    ...
    ComplianceCommentCollection.verify = function verify (message) {
      ...
      if (
        message.complianceComments != null &&
				Object.hasOwn(message, 'complianceComments')
      ) {
        if (!Array.isArray(message.complianceComments)) { return 'complianceComments: array expected' }
        for (let i = 0; i < message.complianceComments.length; i += 1) {
          const error = $root.auditing.ComplianceCommentProto.verify(
            message.complianceComments[i]
          )
          if (error) {
    ...
    ComplianceCommentCollection.fromObject = function fromObject (object) {
      if (object instanceof $root.auditing.ComplianceCommentCollection) { return object }
      const message = new $root.auditing.ComplianceCommentCollection()
      if (object.complianceComments) {
        if (!Array.isArray(object.complianceComments)) {
          throw TypeError(
            '.auditing.ComplianceCommentCollection.complianceComments: array expected'
          )
        }
        message.complianceComments = []
        for (let i = 0; i < object.complianceComments.length; i += 1) {
          if (typeof object.complianceComments[i] !== 'object') {
            throw TypeError(
              '.auditing.ComplianceCommentCollection.complianceComments: object expected'
            )
          }
          message.complianceComments[i] =
						$root.auditing.ComplianceCommentProto.fromObject(
						  object.complianceComments[i]
						)
        }
      }
      return message
    ...
    ComplianceCommentCollection.toObject = function toObject (message, options) {
      ...
      if (message.complianceComments && message.complianceComments.length) {
        object.complianceComments = []
        for (let j = 0; j < message.complianceComments.length; j += 1) {
          object.complianceComments[j] =
						$root.auditing.ComplianceCommentProto.toObject(
						  message.complianceComments[j],
						  options
						)
        }
      }
    ...
    /**
		 ...
		 * @returns {string} The default type url
		 */
    ComplianceCommentCollection.getTypeUrl = function getTypeUrl (
      typeUrlPrefix
    ) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = 'type.googleapis.com'
  ...
  auditing.NonConformanceCommentCollection = (() => {
    ...
    /**
		 ...
		 * @instance
		 */
    NonConformanceCommentCollection.prototype.nonConformanceComments =
			$util.emptyArray
    ...
    NonConformanceCommentCollection.encode = function encode (message, writer) {
      ...
      if (
        message.nonConformanceComments != null &&
				message.nonConformanceComments.length
      ) {
        for (let i = 0; i < message.nonConformanceComments.length; i += 1) {
          $root.auditing.NonConformanceCommentProto.encode(
            message.nonConformanceComments[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
      }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    NonConformanceCommentCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    NonConformanceCommentCollection.decode = function decode (
      reader,
      length,
      error
    ) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.auditing.NonConformanceCommentCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (
              !(
                (message.nonConformanceComments && message.nonConformanceComments.length)
              )
            ) { message.nonConformanceComments = [] }
            message.nonConformanceComments.push(
              $root.auditing.NonConformanceCommentProto.decode(
                reader,
                reader.uint32()
              )
            )
    ...
    /**
		 ...
		 * @throws {$protobuf.util.ProtocolError} If required fields are missing
		 */
    NonConformanceCommentCollection.decodeDelimited = function decodeDelimited (
      reader
    ) {
      if (!(reader instanceof $Reader)) {
        reader = new $Reader(reader);
    ...
    NonConformanceCommentCollection.verify = function verify (message) {
      ...
      if (
        message.nonConformanceComments != null &&
				Object.hasOwn(message, 'nonConformanceComments')
      ) {
        if (!Array.isArray(message.nonConformanceComments)) { return 'nonConformanceComments: array expected' }
        for (let i = 0; i < message.nonConformanceComments.length; i += 1) {
          const error = $root.auditing.NonConformanceCommentProto.verify(
            message.nonConformanceComments[i]
          )
          if (error) {
    ...
    NonConformanceCommentCollection.fromObject = function fromObject (object) {
      if (object instanceof $root.auditing.NonConformanceCommentCollection) { return object }
      const message = new $root.auditing.NonConformanceCommentCollection()
      if (object.nonConformanceComments) {
        if (!Array.isArray(object.nonConformanceComments)) {
          throw TypeError(
            '.auditing.NonConformanceCommentCollection.nonConformanceComments: array expected'
          )
        }
        message.nonConformanceComments = []
        for (let i = 0; i < object.nonConformanceComments.length; i += 1) {
          if (typeof object.nonConformanceComments[i] !== 'object') {
            throw TypeError(
              '.auditing.NonConformanceCommentCollection.nonConformanceComments: object expected'
            )
          }
          message.nonConformanceComments[i] =
						$root.auditing.NonConformanceCommentProto.fromObject(
						  object.nonConformanceComments[i]
						)
        }
      }
      return message
    ...
    /**
		 ...
		 * @returns {Object.<string,*>} Plain object
		 */
    NonConformanceCommentCollection.toObject = function toObject (
      message,
      options
    ) {
      if (!options) {
      ...
      const object = {}
      if (options.arrays || options.defaults) { object.nonConformanceComments = [] }
      if (
        message.nonConformanceComments &&
				message.nonConformanceComments.length
      ) {
        object.nonConformanceComments = []
        for (let j = 0; j < message.nonConformanceComments.length; j += 1) {
          object.nonConformanceComments[j] =
						$root.auditing.NonConformanceCommentProto.toObject(
						  message.nonConformanceComments[j],
						  options
						)
        }
      }
    ...
    /**
		 ...
		 * @returns {string} The default type url
		 */
    NonConformanceCommentCollection.getTypeUrl = function getTypeUrl (
      typeUrlPrefix
    ) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = 'type.googleapis.com'
...
$root.obligations = (() => {
  ...
  obligations.ObligationProto = (() => {
    ...
    ObligationProto.encode = function encode (message, writer) {
      ...
      if (
        message.obligationNumber != null &&
				Object.hasOwn(message, 'obligationNumber')
      ) {
        writer
      ...
      if (message.projectId != null && Object.hasOwn(message, 'projectId')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.projectId) }
      if (
        message.primaryEnvironmentalMechanismId != null &&
				Object.hasOwn(message, 'primaryEnvironmentalMechanismId')
      ) {
        writer
          .uint32(/* id 3, wireType 2 = */ 26)
          .string(message.primaryEnvironmentalMechanismId)
      }
      if (message.procedure != null && Object.hasOwn(message, 'procedure')) { writer.uint32(/* id 4, wireType 2 = */ 34).string(message.procedure) }
      if (
        message.environmentalAspect != null &&
				Object.hasOwn(message, 'environmentalAspect')
      ) {
        writer
          .uint32(/* id 5, wireType 2 = */ 42)
          .string(message.environmentalAspect)
      }
      if (
        message.customEnvironmentalAspect != null &&
				Object.hasOwn(message, 'customEnvironmentalAspect')
      ) {
        writer
          .uint32(/* id 6, wireType 2 = */ 50)
          .string(message.customEnvironmentalAspect)
      }
      if (message.obligation != null && Object.hasOwn(message, 'obligation')) { writer.uint32(/* id 7, wireType 2 = */ 58).string(message.obligation) }
      if (
        message.accountability != null &&
				Object.hasOwn(message, 'accountability')
      ) {
        writer
          .uint32(/* id 8, wireType 2 = */ 66)
          .string(message.accountability)
      }
      if (
        message.responsibleUserIds != null &&
				message.responsibleUserIds.length
      ) {
        for (let i = 0; i < message.responsibleUserIds.length; i += 1) {
          writer
            .uint32(/* id 9, wireType 2 = */ 74)
            .string(message.responsibleUserIds[i])
        }
      }
      if (
        message.projectPhase != null &&
				Object.hasOwn(message, 'projectPhase')
      ) { writer.uint32(/* id 10, wireType 2 = */ 82).string(message.projectPhase) }
      if (
        message.actionDueDate != null &&
				Object.hasOwn(message, 'actionDueDate')
      ) {
        writer
          .uint32(/* id 11, wireType 2 = */ 90)
          .string(message.actionDueDate)
      }
      if (
        message.closeOutDate != null &&
				Object.hasOwn(message, 'closeOutDate')
      ) { writer.uint32(/* id 12, wireType 2 = */ 98).string(message.closeOutDate) }
      if (message.status != null && Object.hasOwn(message, 'status')) { writer.uint32(/* id 13, wireType 2 = */ 106).string(message.status) }
      if (
        message.supportingInformation != null &&
				Object.hasOwn(message, 'supportingInformation')
      ) {
        writer
          .uint32(/* id 14, wireType 2 = */ 114)
          .string(message.supportingInformation)
      }
      if (
        message.generalComments != null &&
				Object.hasOwn(message, 'generalComments')
      ) {
        writer
          .uint32(/* id 15, wireType 2 = */ 122)
          .string(message.generalComments)
      }
      if (
        message.evidenceNotes != null &&
				Object.hasOwn(message, 'evidenceNotes')
      ) {
        writer
          .uint32(/* id 16, wireType 2 = */ 130)
          .string(message.evidenceNotes)
      }
      if (
        message.recurringObligation != null &&
				Object.hasOwn(message, 'recurringObligation')
      ) {
        writer
          .uint32(/* id 17, wireType 0 = */ 136)
          .bool(message.recurringObligation)
      }
      if (
        message.recurringFrequency != null &&
				Object.hasOwn(message, 'recurringFrequency')
      ) {
        writer
          .uint32(/* id 18, wireType 2 = */ 146)
          .string(message.recurringFrequency)
      }
      if (
        message.recurringStatus != null &&
				Object.hasOwn(message, 'recurringStatus')
      ) {
        writer
          .uint32(/* id 19, wireType 2 = */ 154)
          .string(message.recurringStatus)
      }
      if (
        message.recurringForecastedDate != null &&
				Object.hasOwn(message, 'recurringForecastedDate')
      ) {
        writer
          .uint32(/* id 20, wireType 2 = */ 162)
          .string(message.recurringForecastedDate)
      }
      if (message.inspection != null && Object.hasOwn(message, 'inspection')) { writer.uint32(/* id 21, wireType 0 = */ 168).bool(message.inspection) }
      if (
        message.inspectionFrequency != null &&
				Object.hasOwn(message, 'inspectionFrequency')
      ) {
        writer
          .uint32(/* id 22, wireType 2 = */ 178)
          .string(message.inspectionFrequency)
      }
      if (
        message.siteOrDesktop != null &&
				Object.hasOwn(message, 'siteOrDesktop')
      ) {
        writer
          .uint32(/* id 23, wireType 2 = */ 186)
          .string(message.siteOrDesktop)
      }
      if (
        message.newControlActionRequired != null &&
				Object.hasOwn(message, 'newControlActionRequired')
      ) {
        writer
          .uint32(/* id 24, wireType 0 = */ 192)
          .bool(message.newControlActionRequired)
      }
      if (
        message.obligationType != null &&
				Object.hasOwn(message, 'obligationType')
      ) {
        writer
          .uint32(/* id 25, wireType 2 = */ 202)
          .string(message.obligationType)
      }
      if (message.gapAnalysis != null && Object.hasOwn(message, 'gapAnalysis')) { writer.uint32(/* id 26, wireType 0 = */ 208).bool(message.gapAnalysis) }
      if (
        message.notesForGapAnalysis != null &&
				Object.hasOwn(message, 'notesForGapAnalysis')
      ) {
        writer
          .uint32(/* id 27, wireType 2 = */ 218)
          .string(message.notesForGapAnalysis)
      }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 28, wireType 2 = */ 226).string(message.createdAt) }
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) { writer.uint32(/* id 29, wireType 2 = */ 234).string(message.updatedAt) }
      return writer
    }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    ObligationProto.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    ObligationProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.obligations.ObligationProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          ...
          case 9: {
            if (
              !(message.responsibleUserIds && message.responsibleUserIds.length)
    ...
    ObligationProto.verify = function verify (message) {
      ...
      if (
        ...
        if (!$util.isString(message.obligationNumber)) { return 'obligationNumber: string expected' }
      }
      if (message.projectId != null && Object.hasOwn(message, 'projectId')) {
        if (!$util.isString(message.projectId)) { return 'projectId: string expected' }
      }
      if (
        ...
        if (!$util.isString(message.primaryEnvironmentalMechanismId)) { return 'primaryEnvironmentalMechanismId: string expected' }
      }
      if (message.procedure != null && Object.hasOwn(message, 'procedure')) {
        if (!$util.isString(message.procedure)) { return 'procedure: string expected' }
      }
      if (
        message.environmentalAspect != null &&
				Object.hasOwn(message, 'environmentalAspect')
      ) {
        if (!$util.isString(message.environmentalAspect)) { return 'environmentalAspect: string expected' }
      }
      if (
        message.customEnvironmentalAspect != null &&
				Object.hasOwn(message, 'customEnvironmentalAspect')
      ) {
        if (!$util.isString(message.customEnvironmentalAspect)) { return 'customEnvironmentalAspect: string expected' }
      }
      if (message.obligation != null && Object.hasOwn(message, 'obligation')) {
        if (!$util.isString(message.obligation)) { return 'obligation: string expected' }
      }
      if (
        message.accountability != null &&
				Object.hasOwn(message, 'accountability')
      ) {
        if (!$util.isString(message.accountability)) { return 'accountability: string expected' }
      }
      if (
        message.responsibleUserIds != null &&
				Object.hasOwn(message, 'responsibleUserIds')
      ) {
        if (!Array.isArray(message.responsibleUserIds)) { return 'responsibleUserIds: array expected' }
        for (let i = 0; i < message.responsibleUserIds.length; i += 1) {
          if (!$util.isString(message.responsibleUserIds[i])) { return 'responsibleUserIds: string[] expected' }
        }
      }
      if (
        message.projectPhase != null &&
        ...
        if (!$util.isString(message.projectPhase)) { return 'projectPhase: string expected' }
      }
      if (
        message.actionDueDate != null &&
				Object.hasOwn(message, 'actionDueDate')
      ) {
        if (!$util.isString(message.actionDueDate)) { return 'actionDueDate: string expected' }
      }
      if (
        message.closeOutDate != null &&
				Object.hasOwn(message, 'closeOutDate')
      ) {
        if (!$util.isString(message.closeOutDate)) { return 'closeOutDate: string expected' }
      }
      if (message.status != null && Object.hasOwn(message, 'status')) { if (!$util.isString(message.status)) {
        return 'status: string expected' ;
      }}
      if (
        ...
        if (!$util.isString(message.supportingInformation)) { return 'supportingInformation: string expected' }
      }
      if (
        message.generalComments != null &&
				Object.hasOwn(message, 'generalComments')
      ) {
        if (!$util.isString(message.generalComments)) { return 'generalComments: string expected' }
      }
      if (
        message.evidenceNotes != null &&
				Object.hasOwn(message, 'evidenceNotes')
      ) {
        if (!$util.isString(message.evidenceNotes)) { return 'evidenceNotes: string expected' }
      }
      if (
        message.recurringObligation != null &&
				Object.hasOwn(message, 'recurringObligation')
      ) {
        if (typeof message.recurringObligation !== 'boolean') { return 'recurringObligation: boolean expected' }
      }
      if (
        message.recurringFrequency != null &&
				Object.hasOwn(message, 'recurringFrequency')
      ) {
        if (!$util.isString(message.recurringFrequency)) { return 'recurringFrequency: string expected' }
      }
      if (
        message.recurringStatus != null &&
				Object.hasOwn(message, 'recurringStatus')
      ) {
        if (!$util.isString(message.recurringStatus)) { return 'recurringStatus: string expected' }
      }
      if (
        message.recurringForecastedDate != null &&
				Object.hasOwn(message, 'recurringForecastedDate')
      ) {
        if (!$util.isString(message.recurringForecastedDate)) { return 'recurringForecastedDate: string expected' }
      }
      if (message.inspection != null && Object.hasOwn(message, 'inspection')) {
        if (typeof message.inspection !== 'boolean') { return 'inspection: boolean expected' }
      }
      if (
        message.inspectionFrequency != null &&
				Object.hasOwn(message, 'inspectionFrequency')
      ) {
        if (!$util.isString(message.inspectionFrequency)) { return 'inspectionFrequency: string expected' }
      }
      if (
        message.siteOrDesktop != null &&
				Object.hasOwn(message, 'siteOrDesktop')
      ) {
        if (!$util.isString(message.siteOrDesktop)) { return 'siteOrDesktop: string expected' }
      }
      if (
        message.newControlActionRequired != null &&
				Object.hasOwn(message, 'newControlActionRequired')
      ) {
        if (typeof message.newControlActionRequired !== 'boolean') { return 'newControlActionRequired: boolean expected' }
      }
      if (
        message.obligationType != null &&
				Object.hasOwn(message, 'obligationType')
      ) {
        if (!$util.isString(message.obligationType)) { return 'obligationType: string expected' }
      }
      if (message.gapAnalysis != null && Object.hasOwn(message, 'gapAnalysis')) {
        if (typeof message.gapAnalysis !== 'boolean') { return 'gapAnalysis: boolean expected' }
      }
      if (
        message.notesForGapAnalysis != null &&
				Object.hasOwn(message, 'notesForGapAnalysis')
      ) {
        if (!$util.isString(message.notesForGapAnalysis)) { return 'notesForGapAnalysis: string expected' }
      }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) {
        if (!$util.isString(message.createdAt)) { return 'createdAt: string expected' }
      }
    ...
    ObligationProto.fromObject = function fromObject (object) {
      ...
      const message = new $root.obligations.ObligationProto()
      if (object.obligationNumber != null) { message.obligationNumber = String(object.obligationNumber) }
      if (object.projectId != null) { message.projectId = String(object.projectId) }
      if (object.primaryEnvironmentalMechanismId != null) {
        message.primaryEnvironmentalMechanismId = String(
          object.primaryEnvironmentalMechanismId
        )
      }
      if (object.procedure != null) { message.procedure = String(object.procedure) }
      if (object.environmentalAspect != null) { message.environmentalAspect = String(object.environmentalAspect) }
      if (object.customEnvironmentalAspect != null) {
        message.customEnvironmentalAspect = String(
          object.customEnvironmentalAspect
        )
      }
      if (object.obligation != null) { message.obligation = String(object.obligation) }
      if (object.accountability != null) { message.accountability = String(object.accountability) }
      if (object.responsibleUserIds) {
        if (!Array.isArray(object.responsibleUserIds)) {
          throw TypeError(
            '.obligations.ObligationProto.responsibleUserIds: array expected'
          )
        }
        message.responsibleUserIds = []
        for (let i = 0; i < object.responsibleUserIds.length; i += 1) { message.responsibleUserIds[i] = String(object.responsibleUserIds[i]) }
      }
      if (object.projectPhase != null) { message.projectPhase = String(object.projectPhase) }
      if (object.actionDueDate != null) { message.actionDueDate = String(object.actionDueDate) }
      if (object.closeOutDate != null) { message.closeOutDate = String(object.closeOutDate) }
      if (object.status != null) {
        message.status = String(object.status);
      }
      if (object.supportingInformation != null) { message.supportingInformation = String(object.supportingInformation) }
      if (object.generalComments != null) { message.generalComments = String(object.generalComments) }
      if (object.evidenceNotes != null) { message.evidenceNotes = String(object.evidenceNotes) }
      if (object.recurringObligation != null) { message.recurringObligation = Boolean(object.recurringObligation) }
      if (object.recurringFrequency != null) { message.recurringFrequency = String(object.recurringFrequency) }
      if (object.recurringStatus != null) { message.recurringStatus = String(object.recurringStatus) }
      if (object.recurringForecastedDate != null) {
        message.recurringForecastedDate = String(
          object.recurringForecastedDate
        )
      }
      if (object.inspection != null) { message.inspection = Boolean(object.inspection) }
      if (object.inspectionFrequency != null) { message.inspectionFrequency = String(object.inspectionFrequency) }
      if (object.siteOrDesktop != null) { message.siteOrDesktop = String(object.siteOrDesktop) }
      if (object.newControlActionRequired != null) {
        message.newControlActionRequired = Boolean(
          object.newControlActionRequired
        )
      }
      if (object.obligationType != null) { message.obligationType = String(object.obligationType) }
      if (object.gapAnalysis != null) { message.gapAnalysis = Boolean(object.gapAnalysis) }
      if (object.notesForGapAnalysis != null) { message.notesForGapAnalysis = String(object.notesForGapAnalysis) }
      if (object.createdAt != null) { message.createdAt = String(object.createdAt) }
      if (object.updatedAt != null) { message.updatedAt = String(object.updatedAt) }
      return message
    }
    ...
    ObligationProto.toObject = function toObject (message, options) {
      ...
      if (
        ...
        object.primaryEnvironmentalMechanismId =
					message.primaryEnvironmentalMechanismId
      }
      if (message.procedure != null && Object.hasOwn(message, 'procedure')) { object.procedure = message.procedure }
      if (
        message.environmentalAspect != null &&
				Object.hasOwn(message, 'environmentalAspect')
      ...
      if (message.obligation != null && Object.hasOwn(message, 'obligation')) { object.obligation = message.obligation }
      if (
        message.accountability != null &&
				Object.hasOwn(message, 'accountability')
      ...
      if (message.responsibleUserIds && message.responsibleUserIds.length) {
        object.responsibleUserIds = []
        for (let j = 0; j < message.responsibleUserIds.length; j += 1) { object.responsibleUserIds[j] = message.responsibleUserIds[j] }
      }
      if (
        message.projectPhase != null &&
				Object.hasOwn(message, 'projectPhase')
      ...
      if (message.inspection != null && Object.hasOwn(message, 'inspection')) { object.inspection = message.inspection }
      if (
        message.inspectionFrequency != null &&
				Object.hasOwn(message, 'inspectionFrequency')
      ...
      if (message.gapAnalysis != null && Object.hasOwn(message, 'gapAnalysis')) { object.gapAnalysis = message.gapAnalysis }
      if (
        message.notesForGapAnalysis != null &&
				Object.hasOwn(message, 'notesForGapAnalysis')
  ...
  obligations.ObligationCollection = (() => {
    ...
    ObligationCollection.encode = function encode (message, writer) {
      ...
      if (message.obligations != null && message.obligations.length) {
        for (let i = 0; i < message.obligations.length; i += 1) {
          $root.obligations.ObligationProto.encode(
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    ObligationCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    ObligationCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.obligations.ObligationCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.obligations && message.obligations.length)) { message.obligations = [] }
            message.obligations.push(
              $root.obligations.ObligationProto.decode(reader, reader.uint32())
            )
            break
          }
          default:
    ...
    ObligationCollection.verify = function verify (message) {
      ...
      if (
        message.obligations != null &&
				Object.hasOwn(message, 'obligations')
      ) {
        if (!Array.isArray(message.obligations)) { return 'obligations: array expected' }
        for (let i = 0; i < message.obligations.length; i += 1) {
          const error = $root.obligations.ObligationProto.verify(
            message.obligations[i]
          )
          if (error) {
    ...
    ObligationCollection.fromObject = function fromObject (object) {
      if (object instanceof $root.obligations.ObligationCollection) { return object }
      const message = new $root.obligations.ObligationCollection()
      if (object.obligations) {
        if (!Array.isArray(object.obligations)) {
          throw TypeError(
            '.obligations.ObligationCollection.obligations: array expected'
          )
        }
        message.obligations = []
        for (let i = 0; i < object.obligations.length; i += 1) {
          if (typeof object.obligations[i] !== 'object') {
            throw TypeError(
              '.obligations.ObligationCollection.obligations: object expected'
            )
          }
          message.obligations[i] = $root.obligations.ObligationProto.fromObject(
    ...
    ObligationCollection.toObject = function toObject (message, options) {
      ...
      if (message.obligations && message.obligations.length) {
        ...
        for (let j = 0; j < message.obligations.length; j += 1) {
          object.obligations[j] = $root.obligations.ObligationProto.toObject(
  ...
  greenova.mechanisms = (() => {
    ...
    mechanisms.ObligationInsight = (() => {
      ...
      ObligationInsight.encode = function encode (message, writer) {
        ...
        if (message.dueDate != null && Object.hasOwn(message, 'dueDate')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.dueDate) }
        if (
          message.closeOutDate != null &&
					Object.hasOwn(message, 'closeOutDate')
        ) {
      ...
      ObligationInsight.verify = function verify (message) {
        ...
        if (message.dueDate != null && Object.hasOwn(message, 'dueDate')) {
          if (!$util.isString(message.dueDate)) { return 'dueDate: string expected' }
        }
        if (
          message.closeOutDate != null &&
					Object.hasOwn(message, 'closeOutDate')
      ...
      ObligationInsight.fromObject = function fromObject (object) {
        if (object instanceof $root.greenova.mechanisms.ObligationInsight) { return object }
        const message = new $root.greenova.mechanisms.ObligationInsight()
        if (object.obligationNumber != null) { message.obligationNumber = String(object.obligationNumber) }
        if (object.dueDate != null) {
          message.dueDate = String(object.dueDate);
    ...
    mechanisms.ObligationInsightResponse = (() => {
      /**
      ...
      ObligationInsightResponse.encode = function encode (message, writer) {
        ...
        if (
          message.mechanismId != null &&
					Object.hasOwn(message, 'mechanismId')
        ) { writer.uint32(/* id 1, wireType 0 = */ 8).int32(message.mechanismId) }
        if (message.status != null && Object.hasOwn(message, 'status')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.status) }
        if (message.statusKey != null && Object.hasOwn(message, 'statusKey')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.statusKey) }
        if (message.count != null && Object.hasOwn(message, 'count')) { writer.uint32(/* id 4, wireType 0 = */ 32).int32(message.count) }
        if (message.totalCount != null && Object.hasOwn(message, 'totalCount')) { writer.uint32(/* id 5, wireType 0 = */ 40).int32(message.totalCount) }
        if (message.obligations != null && message.obligations.length) {
          for (let i = 0; i < message.obligations.length; i += 1) {
        ...
        if (message.error != null && Object.hasOwn(message, 'error')) { writer.uint32(/* id 7, wireType 2 = */ 58).string(message.error) }
        return writer
      }
      ...
      ObligationInsightResponse.decode = function decode (
        ...
        const end = length === undefined ? reader.len : reader.pos + length
        const message = new $root.greenova.mechanisms.ObligationInsightResponse()
        while (reader.pos < end) {
          const tag = reader.uint32()
          if (tag === error) {
            break;
      ...
      ObligationInsightResponse.verify = function verify (message) {
        ...
        if (
          ...
          if (!$util.isInteger(message.mechanismId)) { return 'mechanismId: integer expected' }
        }
        if (message.status != null && Object.hasOwn(message, 'status')) { if (!$util.isString(message.status)) {
          return 'status: string expected' ;
        }}
        if (message.statusKey != null && Object.hasOwn(message, 'statusKey')) {
          if (!$util.isString(message.statusKey)) { return 'statusKey: string expected' }
        }
        if (message.count != null && Object.hasOwn(message, 'count')) { if (!$util.isInteger(message.count)) {
          return 'count: integer expected' ;
        }}
        if (message.totalCount != null && Object.hasOwn(message, 'totalCount')) {
        ...
        if (message.error != null && Object.hasOwn(message, 'error')) { if (!$util.isString(message.error)) {
      ...
      ObligationInsightResponse.fromObject = function fromObject (object) {
        ...
        const message = new $root.greenova.mechanisms.ObligationInsightResponse()
        if (object.mechanismId != null) { message.mechanismId = object.mechanismId | 0 }
        if (object.status != null) {
          message.status = String(object.status);
        }
        if (object.statusKey != null) { message.statusKey = String(object.statusKey) }
      ...
      ObligationInsightResponse.toObject = function toObject (message, options) {
        ...
        if (message.status != null && Object.hasOwn(message, 'status')) { object.status = message.status }
        if (message.statusKey != null && Object.hasOwn(message, 'statusKey')) { object.statusKey = message.statusKey }
        if (message.count != null && Object.hasOwn(message, 'count')) { object.count = message.count }
        if (message.totalCount != null && Object.hasOwn(message, 'totalCount')) { object.totalCount = message.totalCount }
        if (message.obligations && message.obligations.length) {
          object.obligations = []
          for (let j = 0; j < message.obligations.length; j += 1) {
        ...
        if (message.error != null && Object.hasOwn(message, 'error')) { object.error = message.error }
        return object
      }
    ...
    mechanisms.ChartSegment = (() => {
      ...
      ChartSegment.encode = function encode (message, writer) {
        ...
        if (message.label != null && Object.hasOwn(message, 'label')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.label) }
        if (message.value != null && Object.hasOwn(message, 'value')) { writer.uint32(/* id 2, wireType 0 = */ 16).int32(message.value) }
        if (message.color != null && Object.hasOwn(message, 'color')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.color) }
        return writer
      }
      ...
      ChartSegment.verify = function verify (message) {
        if (typeof message !== 'object' || message === null) { return 'object expected' }
        if (message.label != null && Object.hasOwn(message, 'label')) { if (!$util.isString(message.label)) {
          return 'label: string expected' ;
        }}
        if (message.value != null && Object.hasOwn(message, 'value')) { if (!$util.isInteger(message.value)) {
          return 'value: integer expected' ;
        }}
        if (message.color != null && Object.hasOwn(message, 'color')) { if (!$util.isString(message.color)) {
      ...
      ChartSegment.fromObject = function fromObject (object) {
        if (object instanceof $root.greenova.mechanisms.ChartSegment) { return object }
        const message = new $root.greenova.mechanisms.ChartSegment()
      ...
      ChartSegment.toObject = function toObject (message, options) {
        ...
        if (message.label != null && Object.hasOwn(message, 'label')) { object.label = message.label }
        if (message.value != null && Object.hasOwn(message, 'value')) { object.value = message.value }
        if (message.color != null && Object.hasOwn(message, 'color')) { object.color = message.color }
        return object
      }
    ...
    mechanisms.ChartData = (() => {
      ...
      ChartData.encode = function encode (message, writer) {
        ...
        if (
          message.mechanismName != null &&
					Object.hasOwn(message, 'mechanismName')
        ) {
          writer
            .uint32(/* id 3, wireType 2 = */ 26)
      ...
      ChartData.decode = function decode (reader, length, error) {
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            case 1: {
              if (!(message.segments && message.segments.length)) { message.segments = [] }
      ...
      ChartData.verify = function verify (message) {
        if (typeof message !== 'object' || message === null) { return 'object expected' }
        if (message.segments != null && Object.hasOwn(message, 'segments')) {
          if (!Array.isArray(message.segments)) { return 'segments: array expected' }
          for (let i = 0; i < message.segments.length; i += 1) {
        ...
        if (
          ...
          if (!$util.isString(message.mechanismName)) { return 'mechanismName: string expected' }
        }
        return null
      }
      ...
      ChartData.fromObject = function fromObject (object) {
        if (object instanceof $root.greenova.mechanisms.ChartData) { return object }
        const message = new $root.greenova.mechanisms.ChartData()
        if (object.segments) {
        ...
        if (object.mechanismId != null) { message.mechanismId = object.mechanismId | 0 }
        if (object.mechanismName != null) { message.mechanismName = String(object.mechanismName) }
        return message
      }
    ...
    mechanisms.ChartResponse = (() => {
      ...
      ChartResponse.encode = function encode (message, writer) {
        ...
        if (message.error != null && Object.hasOwn(message, 'error')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.error) }
        return writer
      }
      ...
      ChartResponse.decode = function decode (reader, length, error) {
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            case 1: {
              if (!(message.charts && message.charts.length)) { message.charts = [] }
              message.charts.push(
      ...
      ChartResponse.verify = function verify (message) {
        if (typeof message !== 'object' || message === null) { return 'object expected' }
        if (message.charts != null && Object.hasOwn(message, 'charts')) {
      ...
      ChartResponse.fromObject = function fromObject (object) {
        if (object instanceof $root.greenova.mechanisms.ChartResponse) { return object }
        const message = new $root.greenova.mechanisms.ChartResponse()
        if (object.charts) {
...
$root.feedback = (() => {
  ...
  feedback.BugReportProto = (() => {
    ...
    /**
		 ...
		 * @instance
		 */
    BugReportProto.prototype.createdAt = $util.Long
    ...
    /**
		 ...
		 * @instance
		 */
    BugReportProto.prototype.updatedAt = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0
    ...
    BugReportProto.encode = function encode (message, writer) {
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { writer.uint32(/* id 1, wireType 0 = */ 8).int32(message.id) }
      if (message.title != null && Object.hasOwn(message, 'title')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.title) }
      if (message.description != null && Object.hasOwn(message, 'description')) { writer.uint32(/* id 3, wireType 2 = */ 26).string(message.description) }
      if (
        message.applicationVersion != null &&
				Object.hasOwn(message, 'applicationVersion')
      ) {
        writer
          .uint32(/* id 4, wireType 2 = */ 34)
          .string(message.applicationVersion)
      }
      if (
        message.operatingSystem != null &&
				Object.hasOwn(message, 'operatingSystem')
      ) {
        writer
          .uint32(/* id 5, wireType 2 = */ 42)
          .string(message.operatingSystem)
      }
      if (message.browser != null && Object.hasOwn(message, 'browser')) { writer.uint32(/* id 6, wireType 2 = */ 50).string(message.browser) }
      if (message.deviceType != null && Object.hasOwn(message, 'deviceType')) { writer.uint32(/* id 7, wireType 2 = */ 58).string(message.deviceType) }
      if (
        message.stepsToReproduce != null &&
				Object.hasOwn(message, 'stepsToReproduce')
      ) {
        writer
          .uint32(/* id 8, wireType 2 = */ 66)
          .string(message.stepsToReproduce)
      }
      if (
        message.expectedBehavior != null &&
				Object.hasOwn(message, 'expectedBehavior')
      ) {
        writer
          .uint32(/* id 9, wireType 2 = */ 74)
          .string(message.expectedBehavior)
      }
      if (
        message.actualBehavior != null &&
				Object.hasOwn(message, 'actualBehavior')
      ) {
        writer
          .uint32(/* id 10, wireType 2 = */ 82)
          .string(message.actualBehavior)
      }
      if (
        message.errorMessages != null &&
				Object.hasOwn(message, 'errorMessages')
      ) {
        writer
          .uint32(/* id 11, wireType 2 = */ 90)
          .string(message.errorMessages)
      }
      if (message.traceReport != null && Object.hasOwn(message, 'traceReport')) { writer.uint32(/* id 12, wireType 2 = */ 98).string(message.traceReport) }
      if (message.frequency != null && Object.hasOwn(message, 'frequency')) { writer.uint32(/* id 13, wireType 0 = */ 104).int32(message.frequency) }
      if (
        message.impactSeverity != null &&
				Object.hasOwn(message, 'impactSeverity')
      ) {
        writer
          .uint32(/* id 14, wireType 0 = */ 112)
          .int32(message.impactSeverity)
      }
      if (
        message.adminSeverity != null &&
				Object.hasOwn(message, 'adminSeverity')
      ) {
        writer
          .uint32(/* id 15, wireType 0 = */ 120)
          .int32(message.adminSeverity)
      }
      if (message.userImpact != null && Object.hasOwn(message, 'userImpact')) { writer.uint32(/* id 16, wireType 2 = */ 130).string(message.userImpact) }
      if (message.workarounds != null && Object.hasOwn(message, 'workarounds')) { writer.uint32(/* id 17, wireType 2 = */ 138).string(message.workarounds) }
      if (
        message.additionalComments != null &&
				Object.hasOwn(message, 'additionalComments')
      ) {
        writer
          .uint32(/* id 18, wireType 2 = */ 146)
          .string(message.additionalComments)
      }
      if (message.userId != null && Object.hasOwn(message, 'userId')) { writer.uint32(/* id 19, wireType 0 = */ 152).int32(message.userId) }
      if (message.username != null && Object.hasOwn(message, 'username')) { writer.uint32(/* id 20, wireType 2 = */ 162).string(message.username) }
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) { writer.uint32(/* id 21, wireType 0 = */ 168).int64(message.createdAt) }
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) { writer.uint32(/* id 22, wireType 0 = */ 176).int64(message.updatedAt) }
      if (
        message.githubIssueUrl != null &&
				Object.hasOwn(message, 'githubIssueUrl')
      ) {
        writer
          .uint32(/* id 23, wireType 2 = */ 186)
          .string(message.githubIssueUrl)
      }
      if (message.status != null && Object.hasOwn(message, 'status')) { writer.uint32(/* id 24, wireType 0 = */ 192).int32(message.status) }
      if (
        message.adminComment != null &&
				Object.hasOwn(message, 'adminComment')
      ) {
        writer
          .uint32(/* id 25, wireType 2 = */ 202)
          .string(message.adminComment)
      }
      return writer
    }
    ...
    BugReportProto.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.feedback.BugReportProto()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    BugReportProto.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.id != null && Object.hasOwn(message, 'id')) { if (!$util.isInteger(message.id)) {
        return 'id: integer expected' ;
      }}
      if (message.title != null && Object.hasOwn(message, 'title')) { if (!$util.isString(message.title)) {
      ...
      if (
        ...
        if (!$util.isString(message.applicationVersion)) { return 'applicationVersion: string expected' }
      }
      if (
        message.operatingSystem != null &&
				Object.hasOwn(message, 'operatingSystem')
      ) {
        if (!$util.isString(message.operatingSystem)) { return 'operatingSystem: string expected' }
      }
      if (message.browser != null && Object.hasOwn(message, 'browser')) { if (!$util.isString(message.browser)) {
      ...
      if (
        ...
        if (!$util.isString(message.stepsToReproduce)) { return 'stepsToReproduce: string expected' }
      }
      if (
        message.expectedBehavior != null &&
				Object.hasOwn(message, 'expectedBehavior')
      ) {
        if (!$util.isString(message.expectedBehavior)) { return 'expectedBehavior: string expected' }
      }
      if (
        message.actualBehavior != null &&
				Object.hasOwn(message, 'actualBehavior')
      ) {
        if (!$util.isString(message.actualBehavior)) { return 'actualBehavior: string expected' }
      }
      if (
        message.errorMessages != null &&
				Object.hasOwn(message, 'errorMessages')
      ) {
        if (!$util.isString(message.errorMessages)) { return 'errorMessages: string expected' }
      }
      if (message.traceReport != null && Object.hasOwn(message, 'traceReport')) {
        if (!$util.isString(message.traceReport)) { return 'traceReport: string expected' }
      }
      if (message.frequency != null && Object.hasOwn(message, 'frequency')) {
      ...
      if (message.userImpact != null && Object.hasOwn(message, 'userImpact')) {
        if (!$util.isString(message.userImpact)) { return 'userImpact: string expected' }
      }
      if (message.workarounds != null && Object.hasOwn(message, 'workarounds')) {
        if (!$util.isString(message.workarounds)) { return 'workarounds: string expected' }
      }
      if (
        message.additionalComments != null &&
				Object.hasOwn(message, 'additionalComments')
      ) {
        if (!$util.isString(message.additionalComments)) { return 'additionalComments: string expected' }
      }
      if (message.userId != null && Object.hasOwn(message, 'userId')) { if (!$util.isInteger(message.userId)) {
      ...
      if (message.createdAt != null && Object.hasOwn(message, 'createdAt')) {
        if (
          !$util.isInteger(message.createdAt) &&
					!(
					  (message.createdAt &&
						$util.isInteger(message.createdAt.low) && $util.isInteger(message.createdAt.high))
					)
      ...
      if (message.updatedAt != null && Object.hasOwn(message, 'updatedAt')) {
        if (
          !$util.isInteger(message.updatedAt) &&
					!(
					  (message.updatedAt &&
						$util.isInteger(message.updatedAt.low) && $util.isInteger(message.updatedAt.high))
					)
      ...
      if (
        ...
        if (!$util.isString(message.githubIssueUrl)) { return 'githubIssueUrl: string expected' }
      }
      ...
      if (
        ...
        if (!$util.isString(message.adminComment)) { return 'adminComment: string expected' }
      }
      return null
    }
    ...
    BugReportProto.fromObject = function fromObject (object) {
      ...
      if (object.description != null) { message.description = String(object.description) }
      if (object.applicationVersion != null) { message.applicationVersion = String(object.applicationVersion) }
      if (object.operatingSystem != null) { message.operatingSystem = String(object.operatingSystem) }
      ...
      if (object.stepsToReproduce != null) { message.stepsToReproduce = String(object.stepsToReproduce) }
      if (object.expectedBehavior != null) { message.expectedBehavior = String(object.expectedBehavior) }
      if (object.actualBehavior != null) { message.actualBehavior = String(object.actualBehavior) }
      if (object.errorMessages != null) { message.errorMessages = String(object.errorMessages) }
      if (object.traceReport != null) { message.traceReport = String(object.traceReport) }
      ...
      if (object.userImpact != null) { message.userImpact = String(object.userImpact) }
      if (object.workarounds != null) { message.workarounds = String(object.workarounds) }
      if (object.additionalComments != null) { message.additionalComments = String(object.additionalComments) }
      if (object.userId != null) {
      ...
      if (object.createdAt != null) {
        ...
        } else if (typeof object.createdAt === 'string') { message.createdAt = parseInt(object.createdAt, 10) } else if (typeof object.createdAt === 'number') { message.createdAt = object.createdAt } else if (typeof object.createdAt === 'object') {
      ...
      if (object.updatedAt != null) {
        if ($util.Long) {
          (message.updatedAt = $util.Long.fromValue(
            object.updatedAt
          )).unsigned = false
        } else if (typeof object.updatedAt === 'string') { message.updatedAt = parseInt(object.updatedAt, 10) } else if (typeof object.updatedAt === 'number') { message.updatedAt = object.updatedAt } else if (typeof object.updatedAt === 'object') {
      ...
      if (object.githubIssueUrl != null) { message.githubIssueUrl = String(object.githubIssueUrl) }
      ...
      if (object.adminComment != null) { message.adminComment = String(object.adminComment) }
      return message
    }
    ...
    BugReportProto.toObject = function toObject (message, options) {
      ...
      if (options.defaults) {
        ...
        object.traceReport = ''
        object.frequency =
					options.enums === String ? 'FREQUENCY_UNKNOWN_UNSPECIFIED' : 0
        object.impactSeverity =
					options.enums === String ? 'SEVERITY_UNDEFINED_UNSPECIFIED' : 0
        object.adminSeverity =
					options.enums === String ? 'SEVERITY_UNDEFINED_UNSPECIFIED' : 0
        object.userImpact = ''
        object.workarounds = ''
      ...
      if (message.id != null && Object.hasOwn(message, 'id')) { object.id = message.id }
      if (message.title != null && Object.hasOwn(message, 'title')) { object.title = message.title }
      if (message.description != null && Object.hasOwn(message, 'description')) { object.description = message.description }
      if (
        message.applicationVersion != null &&
				Object.hasOwn(message, 'applicationVersion')
      ...
      if (message.browser != null && Object.hasOwn(message, 'browser')) { object.browser = message.browser }
      if (message.deviceType != null && Object.hasOwn(message, 'deviceType')) { object.deviceType = message.deviceType }
      if (
        message.stepsToReproduce != null &&
				Object.hasOwn(message, 'stepsToReproduce')
      ...
      if (message.traceReport != null && Object.hasOwn(message, 'traceReport')) { object.traceReport = message.traceReport }
      if (message.frequency != null && Object.hasOwn(message, 'frequency')) {
        object.frequency =
					options.enums === String
					  ? $root.feedback.BugReportProto.Frequency[message.frequency] ===
							undefined
					    ? message.frequency
					    : $root.feedback.BugReportProto.Frequency[message.frequency]
					  : message.frequency
      ...
      if (
        ...
        object.impactSeverity =
					options.enums === String
					  ? $root.feedback.BugReportProto.Severity[message.impactSeverity] ===
							undefined
					    ? message.impactSeverity
					    : $root.feedback.BugReportProto.Severity[message.impactSeverity]
					  : message.impactSeverity
      }
      if (
        ...
        object.adminSeverity =
					options.enums === String
					  ? $root.feedback.BugReportProto.Severity[message.adminSeverity] ===
							undefined
					    ? message.adminSeverity
					    : $root.feedback.BugReportProto.Severity[message.adminSeverity]
					  : message.adminSeverity
      }
      if (message.userImpact != null && Object.hasOwn(message, 'userImpact')) { object.userImpact = message.userImpact }
      if (message.workarounds != null && Object.hasOwn(message, 'workarounds')) { object.workarounds = message.workarounds }
      if (
        message.additionalComments != null &&
				Object.hasOwn(message, 'additionalComments')
      ...
      if (message.status != null && Object.hasOwn(message, 'status')) {
        object.status =
					options.enums === String
					  ? $root.feedback.BugReportProto.Status[message.status] === undefined
					    ? message.status
					    : $root.feedback.BugReportProto.Status[message.status]
					  : message.status
      }
      if (
        message.adminComment != null &&
  ...
  feedback.BugReportCollection = (() => {
    ...
    BugReportCollection.encode = function encode (message, writer) {
      ...
      if (message.reports != null && message.reports.length) {
        for (let i = 0; i < message.reports.length; i += 1) {
          $root.feedback.BugReportProto.encode(
            message.reports[i],
            writer.uint32(/* id 1, wireType 2 = */ 10).fork()
          ).ldelim()
        }
    ...
    /**
		 ...
		 * @returns {$protobuf.Writer} Writer
		 */
    BugReportCollection.encodeDelimited = function encodeDelimited (
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim()
    ...
    BugReportCollection.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.feedback.BugReportCollection()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
        ...
        switch (tag >>> 3) {
          case 1: {
            if (!(message.reports && message.reports.length)) { message.reports = [] }
            message.reports.push(
              $root.feedback.BugReportProto.decode(reader, reader.uint32())
            )
            break
          }
          default:
    ...
    BugReportCollection.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.reports != null && Object.hasOwn(message, 'reports')) {
        if (!Array.isArray(message.reports)) {
          return 'reports: array expected';
        }
        for (let i = 0; i < message.reports.length; i += 1) {
          const error = $root.feedback.BugReportProto.verify(message.reports[i])
          if (error) {
    ...
    BugReportCollection.fromObject = function fromObject (object) {
      ...
      if (object.reports) {
        if (!Array.isArray(object.reports)) {
          throw TypeError(
            '.feedback.BugReportCollection.reports: array expected'
          )
        }
        message.reports = []
        for (let i = 0; i < object.reports.length; i += 1) {
          if (typeof object.reports[i] !== 'object') {
            throw TypeError(
              '.feedback.BugReportCollection.reports: object expected'
            )
          }
          message.reports[i] = $root.feedback.BugReportProto.fromObject(
            object.reports[i]
          )
        }
      }
    ...
    BugReportCollection.toObject = function toObject (message, options) {
      ...
      if (message.reports && message.reports.length) {
        object.reports = []
        for (let j = 0; j < message.reports.length; j += 1) {
          object.reports[j] = $root.feedback.BugReportProto.toObject(
            message.reports[j],
            options
          )
        }
...
$root.chatbot = (() => {
  ...
  chatbot.ChatMessage = (() => {
    ...
    /**
		 ...
		 * @instance
		 */
    ChatMessage.prototype.timestamp = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0
    ...
    ChatMessage.encode = function encode (message, writer) {
      ...
      if (message.userId != null && Object.hasOwn(message, 'userId')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.userId) }
      if (message.content != null && Object.hasOwn(message, 'content')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.content) }
      if (message.timestamp != null && Object.hasOwn(message, 'timestamp')) { writer.uint32(/* id 3, wireType 0 = */ 24).int64(message.timestamp) }
      if (message.type != null && Object.hasOwn(message, 'type')) { writer.uint32(/* id 4, wireType 0 = */ 32).int32(message.type) }
      return writer
    }
    ...
    ChatMessage.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.chatbot.ChatMessage()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    ChatMessage.verify = function verify (message) {
      ...
      if (message.content != null && Object.hasOwn(message, 'content')) { if (!$util.isString(message.content)) {
      ...
      if (message.timestamp != null && Object.hasOwn(message, 'timestamp')) {
        if (
          !$util.isInteger(message.timestamp) &&
					!(
					  (message.timestamp &&
						$util.isInteger(message.timestamp.low) && $util.isInteger(message.timestamp.high))
					)
    ...
    ChatMessage.fromObject = function fromObject (object) {
      ...
      if (object.timestamp != null) {
        ...
        } else if (typeof object.timestamp === 'string') { message.timestamp = parseInt(object.timestamp, 10) } else if (typeof object.timestamp === 'number') { message.timestamp = object.timestamp } else if (typeof object.timestamp === 'object') {
    ...
    ChatMessage.toObject = function toObject (message, options) {
      ...
      if (options.defaults) {
        ...
        object.type =
					options.enums === String ? 'MESSAGE_TYPE_TEXT_UNSPECIFIED' : 0
      }
      if (message.userId != null && Object.hasOwn(message, 'userId')) { object.userId = message.userId }
      if (message.content != null && Object.hasOwn(message, 'content')) { object.content = message.content }
      if (message.timestamp != null && Object.hasOwn(message, 'timestamp')) {
      ...
      if (message.type != null && Object.hasOwn(message, 'type')) {
        object.type =
					options.enums === String
					  ? $root.chatbot.ChatMessage.MessageType[message.type] === undefined
					    ? message.type
					    : $root.chatbot.ChatMessage.MessageType[message.type]
					  : message.type
      }
      return object
    }
  ...
  chatbot.ChatResponse = (() => {
    ...
    /**
		 ...
		 * @instance
		 */
    ChatResponse.prototype.timestamp = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0
    ...
    ChatResponse.encode = function encode (message, writer) {
      ...
      if (message.messageId != null && Object.hasOwn(message, 'messageId')) { writer.uint32(/* id 1, wireType 2 = */ 10).string(message.messageId) }
      if (message.content != null && Object.hasOwn(message, 'content')) { writer.uint32(/* id 2, wireType 2 = */ 18).string(message.content) }
      if (message.timestamp != null && Object.hasOwn(message, 'timestamp')) { writer.uint32(/* id 3, wireType 0 = */ 24).int64(message.timestamp) }
      return writer
    }
    ...
    ChatResponse.decode = function decode (reader, length, error) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length
      const message = new $root.chatbot.ChatResponse()
      while (reader.pos < end) {
        const tag = reader.uint32()
        if (tag === error) {
          break;
    ...
    ChatResponse.verify = function verify (message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.messageId != null && Object.hasOwn(message, 'messageId')) {
    ...
    ChatResponse.toObject = function toObject (message, options) {
      ...
      if (message.messageId != null && Object.hasOwn(message, 'messageId')) { object.messageId = message.messageId }
      if (message.content != null && Object.hasOwn(message, 'content')) { object.content = message.content }
      if (message.timestamp != null && Object.hasOwn(message, 'timestamp')) {
        if (typeof message.timestamp === 'number') {
          object.timestamp =
