...
class CompanyProtoSerializer:
    ...
    def __init__(
        ...
        """
        self.instance: Optional[Company] = instance
        self.initial_data: Optional[bytes] = data
        self.validated_data: Optional[Company] = None
...
class CompanyCollectionProtoSerializer:
    ...
    def __init__(
        self,
        instances: Optional[list[Company]] = None,
        data: Optional[bytes] = None,
    ) -> None:
        """
        ...
        Args:
            ...
            data: Optional protobuf3 binary data to deserialize.
        """
        self.instances: Optional[list[Company]] = instances
        self.initial_data: Optional[bytes] = data
        self.validated_data: Optional[list[Company]] = None
        self.errors: Optional[str] = None
