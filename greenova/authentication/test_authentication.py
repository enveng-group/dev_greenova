...
class TestAuthentication:
    ...
    def test_signup_page_loads(self, client) -> None:
    ...
    def test_logout_requires_login(self, client) -> None:
    ...
    def test_password_reset_page_loads(self, client) -> None:
...
class TestAccountManagement:
    ...
    def test_user_signup(self, client) -> None:
    ...
    def test_login_with_email(self, client, django_user_model) -> None:
    ...
    def test_login_with_username(self, client, django_user_model) -> None:
    ...
    def test_logout(self, client, django_user_model) -> None:
    ...
    def test_password_change(self, client, django_user_model) -> None:
    ...
    def test_email_management(self, client, django_user_model) -> None:
...
class TestSocialAuthentication:
    ...
    def test_github_login_button_exists(self, client) -> None:
    ...
    def test_social_connections_page(self, client, django_user_model) -> None:
...
class TestSessions:
    ...
    def test_session_list_requires_login(self, client) -> None:
    ...
    def test_user_sessions_page(self, client, django_user_model) -> None:
    ...
    def test_sign_out_other_sessions(self, client, django_user_model) -> None:
...
class TestMFA:
    ...
    def test_mfa_index_requires_login(self, client) -> None:
    ...
    def test_mfa_index_page(self, client, django_user_model) -> None:
    ...
    def test_totp_activation(self, client, django_user_model) -> None:
    ...
    def test_webauthn_registration(self, client, django_user_model) -> None:
    ...
    def test_recovery_codes_generation(self, client, django_user_model) -> None:
