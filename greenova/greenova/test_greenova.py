...
class TestAuthentication:
    ...
    def test_login_with_valid_credentials(self, client, regular_user) -> None:
    ...
    def test_logout(self, authenticated_client) -> None:
...
class TestNavigation:
    ...
    def test_unauthenticated_home_redirects_to_landing(self, client) -> None:
    ...
    def test_authenticated_home_redirects_to_dashboard(
