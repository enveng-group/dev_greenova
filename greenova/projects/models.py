...
class Obligation(models.Model):
    ...
    compliance_comments = models.TextField(blank=True)
    non_conformance_comments = models.TextField(blank=True)
    evidence = models.TextField(blank=True)
    person_email = models.EmailField(blank=True)
    recurring_obligation = models.BooleanField(default=False)
    recurring_frequency = models.CharField(max_length=50, blank=True)
    recurring_status = models.CharField(max_length=50, blank=True)
    recurring_forcasted_date = models.DateField(null=True, blank=True)
    inspection = models.BooleanField(default=False)
    inspection_frequency = models.CharField(max_length=50, blank=True)
    ...
    obligation_type = models.CharField(max_length=50, blank=True)
    gap_analysis = models.TextField(blank=True)
    notes_for_gap_analysis = models.TextField(blank=True)
