...
class ProjectMembership(models.Model):
    ...
    def __str__(self) -> str:
        ...
        username = getattr(
            self.user,
            'username',
            'Unknown user') if self.user else 'Unknown user'
        project_name = getattr(
            self.project,
            'name',
            'Unknown project') if self.project else 'Unknown project'
...
class ProjectObligation(models.Model):
    ...
    def __str__(self) -> str:
        ...
        project_name = getattr(
            ...
            'name',
            'Unknown project') if self.project else 'Unknown project'
        obligation_number = getattr(
            self.obligation,
            'obligation_number',
            'Unknown obligation') if self.obligation else 'Unknown obligation'
