...
urlpatterns = [
    ...
    # Protobuf API endpoints for obligations
    path(
        "api/obligations/<str:obligation_number>/export/",
        views.export_obligation,
        name="export_obligation",
    ),
    path(
        "api/obligations/export-all/",
        views.export_all_obligations,
        name="export_all_obligations",
    ),
    path(
        "api/obligations/import/",
        views.import_obligation,
        name="import_obligation",
    ),
]
