...
class ResponsibilityRole(models.Model):
    ...
    company = models.ForeignKey(
        Company, on_delete=models.CASCADE, related_name='responsibility_roles'
    )
...
class ResponsibilityAssignment(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='responsibility_assignments'
    )
    ...
    def __str__(self):
        ...
        return (
            f'{self.user.username} - {self.obligation.obligation_number} - {role_name}'
        )
