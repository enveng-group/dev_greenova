...
class ResponsibilityProtoSerializer:
    ...
    @beartype
    def __init__(self, instance: Responsibility | None = None, data: bytes | None = None) -> None:
...
class ResponsibilityAssignmentProtoSerializer:
    ...
    @beartype
    def __init__(self, instance: ResponsibilityAssignment | None = None, data: bytes | None = None) -> None:
        self.instance = instance
        self.initial_data = data
