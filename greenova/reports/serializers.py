...
from .types import ReportPayloadDict, ExportFormatDict, ReportResultDict
...
class ReportProtoSerializer:
    ...
    def __init__(
        ...
        """
        self.instance: Optional[Report] = instance
        self.initial_data: Optional[bytes] = data
        self.validated_data: Optional[Report] = None
...
class ReportCollectionProtoSerializer:
    ...
    def __init__(
        self,
        instances: Optional[list[Report]] = None,
    ) -> None:
        """
