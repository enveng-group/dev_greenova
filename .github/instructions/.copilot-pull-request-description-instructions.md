...
- [Greenova Pull Request Description Guidelines](#greenova-pull-request-description-guidelines)
  - [PR Title Format](#pr-title-format)
  - [PR Description Structure](#pr-description-structure)
  - [Key Components to Include](#key-components-to-include)
    - [Purpose Section](#purpose-section)
    - [Changes Section](#changes-section)
    - [Testing Section](#testing-section)
    - [Deployment Notes](#deployment-notes)
  - [Django-Specific Notes](#django-specific-notes)
  - [Example Good PR Description](#example-good-pr-description)
