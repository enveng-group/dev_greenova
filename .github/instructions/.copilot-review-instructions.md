...
- [Greenova Code Review Guidelines](#greenova-code-review-guidelines)
  - [Core Principles Review](#core-principles-review)
  - [Code Quality Standards](#code-quality-standards)
  - [Security Review Checklist](#security-review-checklist)
  - [Performance Review](#performance-review)
  - [Accessibility Review](#accessibility-review)
  - [Django-Specific Checks](#django-specific-checks)
  - [Frontend Review](#frontend-review)
  - [Testing Review](#testing-review)
  - [Documentation Review](#documentation-review)
  - [Data-Oriented Programming Review](#data-oriented-programming-review)
  - [5S Assessment](#5s-assessment)
...
- Template implementation:
  - Proper template inheritance for DTL (.html)
    templates
  - Correct syntax usage based on template type
  - Consistent usage of template extension (.html for new templates)
